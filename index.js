...
const JavaScript = [
...

    {
        ...
        {
            question: "Which of the following is the correct syntax for creating an arrow function in JavaScript?",
            answers: [
        ...
        {
            question: "What will the following code output? let arr = [1, 2, 3, 4]; let result = arr.map(num => num * 2); console.log(result);",
            answers: [
        ...
        },
        {
            ...
            answers: [
                ...
                { text: "To sum up all elements in an array to a single value", correct: true },
        ...
        {
            question: "What is the output of the following code? let x = 5; let y = '5'; console.log(x == y);",
            answers: [
                { text: "true", correct: true },
                { text: "false", correct: false },
                { text: "undefined", correct: false },
        ...
        },
        {
            ...
            answers: [
                ...
                { text: "`===` compares values, `==` compares values and types", correct: false },
                { text: "`==` compares strings, `===` compares numbers", correct: false },
                { text: "`===` compares strings, `==` compares numbers", correct: false }
            ]
        },
        {
            question: "What will the following code output? let fruits = ['apple', 'banana', 'mango']; fruits.splice(1, 1, 'grape'); console.log(fruits);",
            answers: [
        ...
        },
        {
            ...
            answers: [
                { text: "let promise = new Promise(resolve, reject) => { ... };", correct: false },
                { text: "let promise = Promise.create(resolve, reject) => { ... };", correct: false },
                { text: "let promise = new Promise((resolve, reject) => { ... });", correct: true },
                { text: "let promise = Promise.create((resolve, reject) => { ... });", correct: false }
            ]
        },
        {
        ...
        },
        {
            ...
            answers: [
                ...
                { text: "To execute a block of code repeatedly with a fixed time delay", correct: false },
                { text: "To execute a block of code after a specified time delay", correct: true },
                { text: "To execute a block of code when an event occurs", correct: false }
            ]
        },
        {
            question: "What will the following code output? let person = { name: 'Alice', age: 25 }; console.log(Object.keys(person));",
            answers: [
        ...
        {
            question: "Which of the following methods is used to add one or more elements to the end of an array and returns the new length of the array?",
            answers: [
        ...
        {
            question: "What is the output of the following code? let a = 10; let b = a++; console.log(b);",
            answers: [
        ...
        {
            question: "What will the following code output? let str = 'Hello, world!'; console.log(str.substring(7, 12));",
            answers: [
        ...
        },
        {
            ...
            answers: [
                { text: "To create a new function that has its `this` keyword set to the provided value", correct: true },
                { text: "To create a new object that inherits from another object", correct: false },
        ...
        {
            question: "Which of the following methods is used to sort the elements of an array?",
            answers: [
        ...
        {
            question: "What is the output of the following code? let x = '5'; console.log(x === 5);",
            answers: [
        ...
        {
            question: "What is the output of the following code? let a = 5; let b = 10; [a, b] = [b, a]; console.log(a, b);",
            answers: [
        ...
        {
            question: "What will the following code output? let x = [1, 2, 3]; x.length = 0; console.log(x);",
            answers: [
        ...
        {
            question: "What will the following code output? let x = 10; let y = x; y = 20; console.log(x);",
            answers: [
                { text: "10", correct: true },
        ...
        {
            question: "What will the following code output? let x = [1, 2, 3]; let y = x.slice(); y.push(4); console.log(x, y);",
            answers: [
        ...
        {
            question: "What will the following code output? let obj = { a: 1, b: 2 }; let newObj = { ...obj, c: 3 }; console.log(newObj);",
            answers: [
        ...
        {
            question: "What is the output of the following code? let x = 0; if (x) { console.log('True'); } else { console.log('False'); }",
            answers: [
                { text: "True", correct: false },
                { text: "False", correct: true },
                { text: "undefined", correct: false },
        ...
        {
            question: "What will the following code output? let x = 'Hello'; let y = [...x]; console.log(y);",
            answers: [
        ...
        {
            question: "What will the following code output? let x = 1; switch (x) { case 1: console.log('One'); break; case 2: console.log('Two'); break; default: console.log('Other'); }",
            answers: [
...
const Bootstrap = [
    ...
    {
        question: "Which class is used to create a basic navigation bar in Bootstrap?",
        answers: [
...

    {
        ...
        answers: [
            ...
            { text: "Makes the image scale appropriately across devices", correct: true },
    ...
    {
        question: "Which class would you use to make a form horizontally aligned in Bootstrap?",
        answers: [
...
const ReactJs = [
...

    {
        ...
        answers: [
            ...
            { text: "A component that only depends on props and state", correct: true },
...

    {
        ...
        answers: [
            ...
            { text: "A component that uses a higher number of props", correct: false }
        ]
    },
...

    {
        ...
        answers: [
            ...
            { text: "To subscribe to a context within a function component", correct: true },
...
const Angular = [
    {
        ...
        answers: [
            ...
            { text: "A front-end framework for developing single-page applications", correct: true },
            { text: "A backend framework for server-side programming", correct: false },
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "A part of the application containing HTML, CSS, and JavaScript for a UI element", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "A set of services and components organized together", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "The process of binding JavaScript data to HTML elements", correct: false },
            { text: "The process of synchronizing data between the model and the view", correct: true },
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "A design pattern for injecting services into components", correct: true },
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "To generate components, services, modules, and more", correct: true },
            { text: "To start the Angular application server", correct: false },
            { text: "To run the Angular unit tests", correct: false }
        ]
    },
    {
        question: "Which operator from RxJS is commonly used to handle asynchronous data in Angular?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "To conditionally include or exclude a portion of the DOM", correct: true },
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "A class that contains business logic and data management code", correct: true },
...
const MaterialUI = [
    {
        ...
        answers: [
            { text: "A front-end framework for developing single-page applications", correct: false },
            { text: "A design system for building React applications with a consistent UI", correct: true },
            { text: "A backend framework for server-side programming", correct: false },
            { text: "A database management system", correct: false }
        ]
    },
    {
        question: "Which company developed the Material Design guidelines that Material-UI is based on?",
        answers: [
            { text: "Apple", correct: false },
            { text: "Microsoft", correct: false },
            { text: "Google", correct: true },
    ...
    {
        question: "What is the primary language used for developing with Material-UI?",
        answers: [
    ...
    {
        question: "Which command is used to install Material-UI in a React project?",
        answers: [
    ...
    {
        question: "What is the purpose of the Material-UI 'ThemeProvider' component?",
        answers: [
            { text: "To apply global styles to the entire application", correct: false },
            { text: "To manage the state of the application", correct: false },
            { text: "To provide a consistent theme across the application", correct: true },
            { text: "To handle routing in the application", correct: false }
        ]
    },
    {
        question: "Which component is used to create a responsive layout grid in Material-UI?",
        answers: [
    ...
    {
        question: "Which component is used to create a modal dialog in Material-UI?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "To provide a wrapper component with utility styling", correct: true },
    ...
    {
        question: "Which Material-UI component is used for creating navigation drawers?",
        answers: [
    ...
    {
        question: "What is the purpose of the 'CssBaseline' component in Material-UI?",
        answers: [
            { text: "To handle form validation", correct: false },
            { text: "To reset and apply a consistent baseline CSS to the application", correct: true },
...
const PHP = [
    ...
    {
        question: "Which function is used to fetch a result row as an associative array in PHP?",
        answers: [
...
const NodeJs = [
    ...
    },
    {
        ...
        answers: [
            { text: "Functions that execute during the lifecycle of a request to the server", correct: true },
            { text: "Middleware is not a concept in Express", correct: false },
            { text: "Functions that execute after a response is sent", correct: false },
            { text: "Functions that execute during the lifecycle of a server start", correct: false }
        ]
    },
    {
    ...
    {
        question: "Which method is used to listen for incoming connections on a specific port in Node.js?",
        answers: [
...
const Python = [
    ...
    {
        question: "Which of the following is a correct syntax to open a file in Python?",
        answers: [
...
const C_Programming = [
    ...
    {
        question: "Which of the following is the correct way to include a standard library header file in C?",
        answers: [
...
const CPP_Programming = [
    ...
    {
        question: "Which operator is used to access a member of a class or structure through a pointer?",
        answers: [
            { text: "->", correct: true },
            { text: ".", correct: false },
            { text: "::", correct: false },
    ...
    {
        question: "Which C++ feature allows a function or an operator to be given more than one definition?",
        answers: [
    ...
    {
        question: "What is the default access level of members in a class if no access specifier is provided?",
        answers: [
    ...
    {
        question: "Which of the following correctly declares a friend function in C++?",
        answers: [
    ...
    {
        question: "What is the correct way to create a constant pointer to an integer in C++?",
        answers: [
    ...
    {
        question: "What is the correct way to allocate memory for an integer array dynamically in C++?",
        answers: [
    ...
    {
        question: "Which operator is used to release dynamically allocated memory in C++?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "A reference can be reassigned to another object", correct: false },
            { text: "References cannot be used as function parameters", correct: false }
        ]
    }
];
////////////////////////////////////////  My SQL   //////////////////////////////////////////////////////////////////
const MySQL = [
    ...
    },
    {
        ...
        answers: [
            { text: "INSERT INTO tableName (column1, column2) VALUES (value1, value2);", correct: true },
            { text: "ADD INTO tableName (column1, column2) VALUES (value1, value2);", correct: false },
            { text: "INSERT ROW INTO tableName (column1, column2) VALUES (value1, value2);", correct: false },
            { text: "NEW ROW INTO tableName (column1, column2) VALUES (value1, value2);", correct: false }
        ]
    },
    {
    ...
    },
    {
        ...
        answers: [
            { text: "ALTER TABLE users ADD COLUMN email VARCHAR(255);", correct: true },
            { text: "ALTER TABLE users ADD email VARCHAR(255);", correct: false },
            { text: "MODIFY TABLE users ADD COLUMN email VARCHAR(255);", correct: false },
            { text: "UPDATE TABLE users ADD COLUMN email VARCHAR(255);", correct: false }
        ]
    },
    {
        question: "Which function is used to return the current date and time in MySQL?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "To enforce a column to accept unique values only", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "CREATE USER 'username'@'host' IDENTIFIED BY 'password';", correct: true },
            { text: "NEW USER 'username'@'host' IDENTIFIED BY 'password';", correct: false },
            { text: "ADD USER 'username'@'host' IDENTIFIED BY 'password';", correct: false },
            { text: "MAKE USER 'username'@'host' IDENTIFIED BY 'password';", correct: false }
        ]
    },
    {
    ...
    },
    {
        ...
        answers: [
            { text: "Automatically generates a unique number for each new record", correct: true },
            { text: "Automatically generates a random value for each new record", correct: false },
            { text: "Automatically increments the value of each record", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "ALTER TABLE tableName MODIFY columnName newDataType;", correct: true },
            { text: "ALTER TABLE tableName CHANGE columnName newDataType;", correct: false },
            { text: "MODIFY TABLE tableName CHANGE columnName newDataType;", correct: false },
            { text: "CHANGE TABLE tableName MODIFY columnName newDataType;", correct: false }
        ]
    },
    {
        question: "Which function is used to find the maximum value in a numeric column?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "Returns the number of rows that match a specified criteria", correct: true },
            { text: "Returns the sum of values in a numeric column", correct: false },
            { text: "Returns the average of values in a numeric column", correct: false },
            { text: "Returns the minimum value in a numeric column", correct: false }
        ]
    },
    {
        question: "Which MySQL statement is used to update existing data in a table?",
        answers: [
            { text: "UPDATE tableName SET columnName = value WHERE condition;", correct: true },
            { text: "MODIFY tableName SET columnName = value WHERE condition;", correct: false },
            { text: "CHANGE tableName SET columnName = value WHERE condition;", correct: false },
            { text: "ALTER tableName SET columnName = value WHERE condition;", correct: false }
        ]
    }
];
//////////////////////////////////////  AI/ML   /////////////////////////////////////////////////////////////////////
const AI_ML = [
    ...
    },
    {
        ...
        answers: [
            { text: "A set of algorithms modeled after the human brain", correct: true },
    ...
    {
        question: "Which term describes the process of training a machine learning model using labeled data?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "A model that performs well on training data but poorly on new data", correct: true },
            { text: "A model that performs well on both training and new data", correct: false },
            { text: "A model that performs poorly on both training and new data", correct: false },
            { text: "A model that performs poorly on training data but well on new data", correct: false }
        ]
    },
    {
    ...
    },
    {
        ...
        answers: [
            { text: "Evaluating the performance of a classification algorithm", correct: true },
    ...
    {
        question: "Which of the following is an example of a reinforcement learning problem?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "A parameter whose value is set before the learning process begins", correct: true },
            { text: "A parameter that is learned during the training process", correct: false },
            { text: "A parameter that controls the size of the dataset", correct: false },
            { text: "A parameter that determines the output of the model", correct: false }
        ]
    },
    {
    ...
    },
    {
        ...
        answers: [
            { text: "To assess how well a model will generalize to an independent dataset", correct: true },
...
const DSA = [
    {
        question: "What is the time complexity of inserting an element at the end of an array of size n, assuming no resizing is needed?",
        answers: [
    ...
    {
        question: "Which data structure allows you to access its elements in Last-In-First-Out (LIFO) order?",
        answers: [
    ...
    {
        question: "What is the worst-case time complexity of searching for an element in a binary search tree (BST) of size n?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "Average O(1) time complexity for insert, delete, and search operations", correct: true },
            { text: "Guaranteed O(1) time complexity for all operations", correct: false },
            { text: "Allows for efficient sorting of elements", correct: false },
            { text: "Supports dynamic resizing without performance degradation", correct: false }
        ]
    },
    {
        question: "Which data structure uses two pointers, usually named 'slow' and 'fast', to detect cycles in a linked list?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "Allows for efficient deletion of nodes without traversal from the head", correct: true },
    ...
    {
        question: "Which data structure uses First-In-First-Out (FIFO) order for its operations?",
        answers: [
    ...
    {
        question: "What is the primary advantage of using an AVL tree over a binary search tree?",
        answers: [
            { text: "Guaranteed O(log n) time complexity for all operations", correct: true },
            { text: "Requires less memory per node", correct: false },
    ...
    {
        question: "Which sorting algorithm is known for its ability to efficiently sort nearly sorted arrays or small arrays?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "To describe the asymptotic upper bound on the time complexity of algorithms", correct: true },
            { text: "To calculate the exact number of operations performed by an algorithm", correct: false },
            { text: "To compare the memory usage of different data structures", correct: false },
            { text: "To measure the efficiency of parallel algorithms", correct: false }
        ]
    },
    {
        question: "Which algorithm is used to find the minimum spanning tree in a weighted, connected graph?",
        answers: [
    ...
    {
        question: "Which data structure is typically used to implement a least recently used (LRU) cache?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "To traverse or search a graph in depth-first order", correct: true },
            { text: "To find the shortest path in a weighted graph", correct: false },
            { text: "To find the strongly connected components in a graph", correct: false },
            { text: "To detect cycles in a directed graph", correct: false }
        ]
    },
    {
        question: "Which data structure uses both breadth-first and depth-first search techniques for efficient searching?",
        answers: [
...
const OOPs = [
    {
        ...
        answers: [
            { text: "Combining data and functions that manipulate the data into a single unit", correct: true },
    ...
    {
        question: "Which concept in OOP refers to the ability of an object to take multiple forms?",
        answers: [
    ...
    {
        question: "Inheritance in OOP allows a class to inherit properties and behaviors from another class. What term describes the class that inherits these properties?",
        answers: [
    ...
    {
        question: "Which OOP principle states that objects of a superclass should be replaceable with objects of its subclasses without affecting the correctness of the program?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "Hiding complex implementation details and showing only the essential features of an object", correct: true },
            { text: "Combining data and functions that manipulate the data into a single unit", correct: false },
            { text: "Allowing a class to inherit properties and behaviors from another class", correct: false },
            { text: "Enabling an object to take multiple forms", correct: false }
        ]
    },
    {
        question: "Which term describes the process of creating a new object based on an existing object?",
        answers: [
    ...
    {
        question: "Which OOP concept emphasizes the separation of concerns by assigning each class a single responsibility?",
        answers: [
    ...
    {
        question: "What is the primary benefit of using interfaces in object-oriented programming?",
        answers: [
            { text: "Enforcing a contract that classes implementing the interface must follow", correct: true },
            { text: "Enabling a class to inherit properties and behaviors from another class", correct: false },
            { text: "Supporting the ability of an object to take multiple forms", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "A class that cannot be instantiated and serves as a base for other classes", correct: true },
            { text: "A class that allows for multiple instances to be created from it", correct: false },
            { text: "A class that inherits properties and behaviors from another class", correct: false },
            { text: "A class that hides the implementation details of its methods", correct: false }
        ]
    },
    {
        ...
        answers: [
            ...
            { text: "Simple, Object-Oriented, Logical, Inheritance, Design", correct: false },
            { text: "Structured, Objectives, Layered, Inheritance, Development", correct: false },
            { text: "Systematic, Ongoing, Logical, Iterative, Development", correct: false }
        ]
    },
    {
        question: "Which OOP principle suggests that a software entity should be open for extension but closed for modification?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "Combining objects of different classes to create more complex objects", correct: true },
            { text: "Allowing a class to inherit properties and behaviors from another class", correct: false },
            { text: "Enabling an object to take multiple forms", correct: false },
            { text: "Hiding complex implementation details and showing only the essential features of an object", correct: false }
        ]
    },
    {
        question: "Which term describes the ability of a class to provide different implementations of its methods based on the input parameters?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "A method that belongs to the class rather than to instances of the class", correct: true },
            { text: "A method that can be overridden by subclasses", correct: false },
            { text: "A method that is declared in an abstract class", correct: false },
            { text: "A method that is available only within a specific package", correct: false }
        ]
    },
    {
        question: "What is the purpose of the 'super' keyword in Java and similar languages?",
        answers: [
            { text: "To refer to the superclass of the current object", correct: true },
    ...
    {
        question: "What is the primary difference between composition and inheritance in object-oriented programming?",
        answers: [
            { text: "Composition allows for more flexible relationships between classes compared to inheritance", correct: true },
            { text: "Inheritance allows for more flexible relationships between classes compared to composition", correct: false },
            { text: "Composition is used for creating multiple instances of a class", correct: false },
            { text: "Inheritance is used for combining data and functions into a single unit", correct: false }
        ]
    },
    {
        question: "Which OOP concept allows you to implement different versions of a method in different classes using inheritance?",
        answers: [
    ...
    {
        question: "What is the primary disadvantage of using inheritance in object-oriented programming?",
        answers: [
            { text: "It can lead to tight coupling between classes, making the system less flexible", correct: true },
            { text: "It requires more memory per object compared to composition", correct: false },
            { text: "It makes it difficult to hide implementation details of a class", correct: false },
            { text: "It limits the ability to extend the functionality of a class", correct: false }
        ]
    },
    {
        question: "Which term describes the process of creating an instance of a class?",
        answers: [
    ...
    {
        question: "What is the primary benefit of using constructors in object-oriented programming?",
        answers: [
...
const Operating_System = [
    {
        ...
        answers: [
            { text: "Software that acts as an intermediary between user applications and computer hardware", correct: true },
            { text: "A program that manages files and folders on a computer", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "A technique that allows the execution of processes that are not completely in memory", correct: true },
            { text: "A type of memory used by virtual machines", correct: false },
            { text: "A memory management technique for organizing files", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "A situation where two or more processes are unable to proceed because each is waiting for one of the others to finish some operation", correct: true },
            { text: "A situation where a process continues to hold onto resources indefinitely", correct: false },
            { text: "A condition where a process loses control of the CPU and is unable to regain it", correct: false },
            { text: "A type of error that occurs during file system operations", correct: false }
        ]
    },
    {
        question: "Which memory management scheme allows processes to be swapped in and out of main memory?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "A method for storing and organizing computer files and their data", correct: true },
            { text: "An algorithm for scheduling disk operations", correct: false },
            { text: "A type of memory used by virtual machines", correct: false },
            { text: "A technique for preventing data loss in case of a system crash", correct: false }
        ]
    },
    {
    ...
    },
    {
        ...
        answers: [
            { text: "An interface provided by the operating system to allow user-level processes to request services from the kernel", correct: true },
            { text: "A command used to launch applications", correct: false },
            { text: "A function used to allocate memory dynamically", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "A variable or abstract data type used to control access to a common resource by multiple processes in a concurrent system", correct: true },
            { text: "A type of CPU scheduling algorithm", correct: false },
            { text: "A memory management technique for organizing files", correct: false },
            { text: "A technique for preventing data loss in case of a system crash", correct: false }
        ]
    },
    {
        ...
        answers: [
            { text: "To allow communication between the operating system and hardware devices", correct: true },
            { text: "To manage memory allocation and deallocation", correct: false },
            { text: "To schedule processes for execution on the CPU", correct: false },
            { text: "To provide an interface for users to interact with the system", correct: false }
        ]
    },
    {
        question: "Which type of operating system allows multiple users to access a computer system concurrently?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "A condition where excessive paging occurs, causing a severe decrease in system performance", correct: true },
            { text: "A technique used to manage multiple threads in a process", correct: false },
            { text: "A deadlock situation involving multiple processes", correct: false },
            { text: "A scheduling algorithm for real-time systems", correct: false }
        ]
    },
    {
        question: "Which type of CPU scheduling algorithm provides the minimum average waiting time for processes?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "The core component of the operating system that provides basic services for all other parts", correct: true },
            { text: "A user-level program used to manage files and folders", correct: false },
            { text: "A type of device driver used to interface with hardware devices", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "A trap to the software raised by the hardware when a process accesses a page that is not mapped", correct: true },
            { text: "An error in the disk scheduling algorithm", correct: false },
            { text: "A condition where a process cannot proceed due to lack of available pages", correct: false },
            { text: "A deadlock situation involving virtual memory allocation", correct: false }
        ]
    },
    {
        question: "What is the purpose of an interrupt in operating systems?",
        answers: [
            { text: "To signal the processor to suspend its current execution and handle the event", correct: true },
            { text: "To manage memory allocation and deallocation", correct: false },
            { text: "To synchronize access to shared resources in a multi-threaded environment", correct: false },
            { text: "To allow communication between the operating system and hardware devices", correct: false }
        ]
    },
    {
        question: "Which disk scheduling algorithm provides the shortest average seek time?",
        answers: [
...
const Compiler_Design = [
    {
        ...
        answers: [
            { text: "A program that translates high-level source code into machine code", correct: true },
            { text: "A tool for debugging software applications", correct: false },
            { text: "A device used to convert analog signals into digital signals", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "Lexical analysis, syntax analysis, semantic analysis, optimization, code generation", correct: true },
            { text: "Optimization, code generation, syntax analysis, lexical analysis, semantic analysis", correct: false },
            { text: "Syntax analysis, lexical analysis, code generation, optimization, semantic analysis", correct: false },
            { text: "Code generation, optimization, lexical analysis, syntax analysis, semantic analysis", correct: false }
        ]
    },
    {
        question: "What is the role of lexical analysis in a compiler?",
        answers: [
            { text: "To convert a sequence of characters into a sequence of tokens", correct: true },
            { text: "To generate optimized code for the target machine", correct: false },
            { text: "To analyze the syntactic structure of the source program", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "A category of lexemes that represent the basic building blocks of a program", correct: true },
            { text: "A type of data structure used for storing intermediate code", correct: false },
            { text: "An optimization technique used during code generation", correct: false },
            { text: "A technique for managing memory allocation in the compiler", correct: false }
        ]
    },
    {
        question: "What does syntax analysis (parsing) do in a compiler?",
        answers: [
            { text: "To check whether the tokens generated by lexical analysis form valid statements in the programming language", correct: true },
            { text: "To translate intermediate code into machine code", correct: false },
            { text: "To perform optimizations on the code", correct: false },
            { text: "To manage the allocation and deallocation of memory", correct: false }
        ]
    },
    {
        question: "What is semantic analysis in compiler design?",
        answers: [
            { text: "To check whether the statements and expressions have a meaning according to the rules of the programming language", correct: true },
            { text: "To generate optimized code for the target machine", correct: false },
            { text: "To convert intermediate code into assembly code", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "To improve the efficiency and performance of the generated code", correct: true },
            { text: "To generate intermediate code from the source program", correct: false },
            { text: "To perform syntax checks on the program", correct: false },
            { text: "To manage the allocation and deallocation of memory", correct: false }
        ]
    },
    {
        ...
        answers: [
            { text: "To translate intermediate code into machine code for a specific computer architecture", correct: true },
            { text: "To analyze the syntactic structure of the source program", correct: false },
            { text: "To perform optimizations on the code", correct: false },
            { text: "To convert high-level source code into intermediate code", correct: false }
        ]
    },
    {
        question: "What is the difference between compiler and interpreter?",
        answers: [
            { text: "A compiler translates high-level source code into machine code, while an interpreter executes high-level source code directly", correct: true },
            { text: "A compiler and an interpreter perform the same functions in software development", correct: false },
            { text: "A compiler and an interpreter are different names for the same software tool", correct: false },
            { text: "A compiler translates machine code into high-level source code, while an interpreter translates high-level source code into machine code", correct: false }
        ]
    },
    {
        question: "What is static vs dynamic linking in compiler design?",
        answers: [
            { text: "Static linking links library code to the executable at compile time, while dynamic linking links library code at runtime", correct: true },
            { text: "Static linking links library code at runtime, while dynamic linking links library code at compile time", correct: false },
            { text: "Static linking does not link library code to the executable, while dynamic linking links library code at runtime", correct: false },
            { text: "Static linking and dynamic linking both refer to the same process in compiler design", correct: false }
        ]
    },
    {
        question: "What is a syntax-directed translation?",
        answers: [
            { text: "A method of translation that uses the syntax of the source language to generate the target language code", correct: true },
            { text: "A technique for optimizing code generation in compilers", correct: false },
            { text: "A type of semantic analysis used in compiler design", correct: false },
            { text: "A method for managing memory allocation in the compiler", correct: false }
        ]
    },
    {
        question: "What is bootstrapping in compiler design?",
        answers: [
            { text: "The process of writing a compiler for a programming language in the same language it compiles", correct: true },
            { text: "A technique for converting intermediate code into machine code", correct: false },
            { text: "The process of generating optimized code for the target machine", correct: false },
            { text: "A method for managing memory allocation in the compiler", correct: false }
        ]
    },
    {
        ...
        answers: [
            { text: "A data structure that stores information about identifiers (variables, functions, etc.) in a program", correct: true },
            { text: "A type of intermediate representation used during code generation", correct: false },
            { text: "A technique for managing memory allocation in the compiler", correct: false },
            { text: "An optimization technique used during code optimization", correct: false }
        ]
    },
    {
        question: "What is the role of a parser generator (like Yacc/Bison) in compiler design?",
        answers: [
            { text: "To generate the syntax analyzer (parser) based on the grammar rules specified by the user", correct: true },
            { text: "To optimize the generated code for the target machine", correct: false },
            { text: "To convert intermediate code into machine code", correct: false },
            { text: "To manage the allocation and deallocation of memory", correct: false }
        ]
    },
    {
        ...
        answers: [
            { text: "A hierarchical representation of the syntactic structure of a program", correct: true },
            { text: "A data structure used to store intermediate code", correct: false },
            { text: "A technique for managing memory allocation in the compiler", correct: false },
            { text: "An optimization technique used during code generation", correct: false }
        ]
    },
    {
        ...
        answers: [
            { text: "To provide a platform-independent representation of the source program before generating machine code", correct: true },
            { text: "To manage the allocation and deallocation of memory", correct: false },
            { text: "To convert high-level source code into assembly code", correct: false },
            { text: "To analyze the syntactic structure of the source program", correct: false }
        ]
    },
    {
        ...
        answers: [
            { text: "The process of assigning variables to registers during code generation to optimize execution speed", correct: true },
            { text: "A method for converting intermediate code into machine code", correct: false },
            { text: "A technique for managing memory allocation in the compiler", correct: false },
            { text: "An optimization technique used during code optimization", correct: false }
        ]
    },
    {
        ...
        answers: [
            { text: "A process that automatically reclaims memory occupied by objects that are no longer in use by the program", correct: true },
            { text: "A technique for optimizing code generation in compilers", correct: false },
            { text: "A type of semantic analysis used in compiler design", correct: false },
            { text: "A method for managing memory allocation in the compiler", correct: false }
        ]
    },
    {
        ...
        answers: [
            { text: "A formalism for describing the syntax and semantics of programming languages using attributes associated with grammar rules", correct: true },
            { text: "A method for generating optimized code for the target machine", correct: false },
            { text: "A technique for converting intermediate code into machine code", correct: false },
            { text: "A technique for managing memory allocation in the compiler", correct: false }]
        },
        {
            ...
            answers: [
                { text: "A set of techniques to optimize the execution speed of loops in the generated code", correct: true },
                { text: "A method for converting intermediate code into machine code", correct: false },
                { text: "A technique for managing memory allocation in the compiler", correct: false },
                { text: "An optimization technique used during code generation", correct: false }
            ]
        },
        {
            ...
            answers: [
                { text: "A process to remove code that does not affect the output of the program", correct: true },
                { text: "A technique for managing memory allocation in the compiler", correct: false },
                { text: "An optimization technique used during code optimization", correct: false },
                { text: "A method for converting intermediate code into machine code", correct: false }
            ]
        },
        {
            ...
            answers: [
                { text: "To break the input program into tokens (lexical analysis)", correct: true },
                { text: "To generate intermediate code for the source program", correct: false },
                { text: "To perform syntax checks on the program", correct: false },
                { text: "To optimize the generated code for the target machine", correct: false }
            ]
        },
        {
            ...
            answers: [
                { text: "A technique to analyze the order of execution of statements and optimize the generated code", correct: true },
                { text: "A method for converting intermediate code into machine code", correct: false },
                { text: "A technique for managing memory allocation in the compiler", correct: false },
                { text: "An optimization technique used during code generation", correct: false }
            ]
        ...
        {
            question: "What is the difference between front-end and back-end in compiler design?",
            answers: [
                { text: "Front-end deals with analyzing and parsing the source code, while back-end deals with optimization and code generation", correct: true },
                { text: "Front-end deals with optimizing the code, while back-end deals with analyzing and parsing the source code", correct: false },
                { text: "Front-end generates the intermediate code, while back-end generates machine code", correct: false },
                { text: "Front-end translates the intermediate code into machine code, while back-end performs syntax analysis", correct: false }
            ]
        },
        {
            question: "What is a semantic action in compiler design?",
            answers: [
                { text: "An action associated with a production rule in the grammar to perform semantic analysis", correct: true },
                { text: "A method for managing memory allocation in the compiler", correct: false },
                { text: "A technique for converting intermediate code into machine code", correct: false },
                { text: "An optimization technique used during code generation", correct: false }
            ]
...
const Cyber_Security = [
    {
        ...
        answers: [
            { text: "A method used to steal confidential information by disguising as a trustworthy entity.", correct: true },
            { text: "A technique to encrypt data during transmission.", correct: false },
...

    {
        ...
        answers: [
            { text: "A method to guess passwords by trying every possible combination.", correct: true },
            { text: "A type of phishing attack using deceptive emails.", correct: false },
            { text: "A malware that hijacks a computer's resources.", correct: false },
...

    {
        ...
        answers: [
            { text: "A security system that controls network traffic based on set rules.", correct: true },
            { text: "A software tool for encrypting files on a disk.", correct: false },
            { text: "A device that scans and removes viruses from a network.", correct: false },
            { text: "A type of phishing attack involving false advertisements.", correct: false }
        ]
    },
...

    {
        ...
        answers: [
            { text: "To simulate cyber attacks to find security vulnerabilities.", correct: true },
            { text: "To develop new encryption algorithms.", correct: false },
            { text: "To monitor network traffic for anomalies.", correct: false },
            { text: "To design firewalls and intrusion detection systems.", correct: false }
        ]
    },

    {
        ...
        answers: [
            { text: "A security method that requires two forms of identification to access an account.", correct: true },
            { text: "A firewall that blocks traffic from two specific IP addresses.", correct: false },
            { text: "A type of encryption using two different algorithms.", correct: false },
            { text: "A hardware device that encrypts data on a local network.", correct: false }
        ]
    },

    {
        ...
        answers: [
            { text: "Distributed Denial of Service attack, which floods a system with traffic to make it unavailable.", correct: true },
            { text: "Digital Defense System used to protect networks from malware.", correct: false },
            { text: "Data-driven Operating System attack that exploits vulnerabilities in OS software.", correct: false },
            { text: "Domain-Driven Security system that monitors domain traffic for threats.", correct: false }
        ]
    },
...

    {
        ...
        answers: [
            { text: "Psychological manipulation of people to gain confidential information.", correct: true },
            { text: "Automated system to simulate user interactions.", correct: false },
            { text: "A type of malware disguised as legitimate software.", correct: false },
            { text: "A hardware tool to test network vulnerabilities.", correct: false }
        ]
    },

    {
        ...
        answers: [
            { text: "Malicious software that encrypts files and demands payment for decryption.", correct: true },
            { text: "A type of virus that spreads through email attachments.", correct: false },
            { text: "A technique to steal login credentials by impersonating a legitimate website.", correct: false },
            { text: "A hardware device used to monitor network traffic.", correct: false }
        ]
    },

    {
        ...
        answers: [
            { text: "To protect computer systems and networks from unauthorized access and attacks.", correct: true },
            { text: "To develop new programming languages.", correct: false },
            { text: "To increase the speed of internet connections.", correct: false },
...

    {
        ...
        answers: [
            { text: "White hat hackers use their skills for ethical hacking and security testing, while black hat hackers engage in illegal activities.", correct: true },
            { text: "White hat hackers develop new encryption algorithms, while black hat hackers steal personal data.", correct: false },
            { text: "White hat hackers work for government agencies, while black hat hackers work for private companies.", correct: false },
            { text: "White hat hackers focus on network security, while black hat hackers focus on hardware vulnerabilities.", correct: false }
        ]
    },

    {
        ...
        answers: [
            { text: "Dividing a network into smaller subnetworks to improve security and performance.", correct: true },
            { text: "Scanning a network for vulnerabilities.", correct: false },
            { text: "Encrypting network traffic to prevent eavesdropping.", correct: false },
            { text: "Securing wireless networks with strong passwords.", correct: false }
        ]
    },

    {
        ...
        answers: [
            { text: "A process to identify and prioritize weaknesses in a computer system.", correct: true },
            { text: "A method to prevent unauthorized access to a network.", correct: false },
            { text: "A type of encryption used for secure data storage.", correct: false },
            { text: "A hardware device that monitors network traffic.", correct: false }
        ]
    },

    {
        ...
        answers: [
            { text: "To handle and mitigate security breaches and incidents.", correct: true },
            { text: "To develop new software patches and updates.", correct: false },
            { text: "To perform regular audits of network infrastructure.", correct: false },
...

    {
        ...
        answers: [
            ...
            { text: "Confidentiality, Identification, Authentication.", correct: false },
...

    {
        ...
        answers: [
            { text: "Encryption keys are used to encrypt and decrypt data securely.", correct: true },
            { text: "Encryption keys protect physical access to servers.", correct: false },
            { text: "Encryption keys monitor network traffic for vulnerabilities.", correct: false },
            { text: "Encryption keys secure wireless network connections.", correct: false }
        ]
    },

    {
        ...
        answers: [
            { text: "A decoy system designed to lure hackers and study their techniques.", correct: true },
            { text: "A type of malware that spreads through email attachments.", correct: false },
            { text: "A hardware device used to monitor network traffic.", correct: false },
            { text: "A social engineering technique to gain access to sensitive information.", correct: false }
        ]
    }
];
/////////////////////////////////////////////////  I   o   T   //////////////////////////////////////////////////////
const IoT = [
...

    {
        ...
        answers: [
            { text: "A device that detects physical or environmental changes and sends signals to other devices.", correct: true },
...

    {
        ...
        answers: [
            { text: "Processing data closer to where it is generated rather than sending it across long routes to data centers.", correct: true },
            { text: "A security measure to protect IoT devices from cyber attacks.", correct: false },
            { text: "An algorithm used to encrypt IoT data.", correct: false },
            { text: "A network topology for connecting IoT devices.", correct: false }
        ]
    },

    {
        ...
        answers: [
            { text: "To track and identify objects using radio waves.", correct: true },
            { text: "To provide internet connectivity to IoT devices.", correct: false },
            { text: "To analyze large amounts of IoT data.", correct: false },
            { text: "To secure IoT devices from unauthorized access.", correct: false }
        ]
    },

    {
        ...
        answers: [
            { text: "To control physical devices based on data received from sensors.", correct: true },
            { text: "To collect data from the environment and send it to IoT devices.", correct: false },
            { text: "To process and analyze data collected by IoT devices.", correct: false },
...

    {
        ...
        answers: [
            { text: "Device authentication, data encryption, and secure firmware updates.", correct: true },
...

    {
        ...
        answers: [
            { text: "A home equipped with IoT devices for automation and control.", correct: true },
            { text: "A network of computers connected to the internet.", correct: false },
            { text: "A security measure to protect IoT networks.", correct: false },
            { text: "A software platform for developing IoT applications.", correct: false }
        ]
    },

    {
        ...
        answers: [
            { text: "To analyze IoT data and make autonomous decisions.", correct: true },
            { text: "To secure IoT devices from cyber attacks.", correct: false },
            { text: "To provide internet connectivity to IoT devices.", correct: false },
            { text: "To develop new protocols for IoT communication.", correct: false }
        ]
    },

    {
        ...
        answers: [
            { text: "The network of interconnected IoT devices, platforms, and services.", correct: true },
            { text: "The physical components of IoT devices.", correct: false },
            { text: "The process of deploying IoT solutions.", correct: false },
            { text: "The legal framework governing IoT technologies.", correct: false }
        ]
    },

    {
        ...
        answers: [
            { text: "A decentralized computing infrastructure for IoT applications.", correct: true },
            { text: "A security measure to protect IoT networks from cyber attacks.", correct: false },
            { text: "A protocol used for communication between IoT devices and the cloud.", correct: false },
            { text: "A type of encryption algorithm used in IoT devices.", correct: false }
        ]
    },

    {
        ...
        answers: [
            { text: "To provide secure and transparent transactions between IoT devices.", correct: true },
...

    {
        ...
        answers: [
            { text: "Machine-to-Machine communication, where IoT devices exchange data without human intervention.", correct: true },
            { text: "Mobile-to-Mobile communication, using cellular networks for IoT connectivity.", correct: false },
            { text: "Market-to-Market communication, facilitating trade between IoT vendors.", correct: false },
            { text: "Media-to-Media communication, sharing multimedia content over IoT networks.", correct: false }
        ]
    },

    {
        ...
        answers: [
            { text: "Smart thermostats, wearable fitness trackers, and voice-activated assistants.", correct: true },
            { text: "Industrial robots, automated manufacturing systems, and drones.", correct: false },
            { text: "IoT sensors for environmental monitoring.", correct: false },
            { text: "Blockchain-enabled devices for secure data storage.", correct: false }
        ]
    },

    {
        ...
        answers: [
            { text: "A virtual representation of a physical IoT device or system.", correct: true },
            { text: "An encryption key used to secure IoT data transmissions.", correct: false },
...

    {
        ...
        answers: [
            { text: "To analyze large volumes of IoT data to extract valuable insights.", correct: true },
            { text: "To secure IoT devices from cyber attacks.", correct: false },
            { text: "To provide internet connectivity to IoT devices.", correct: false },
            { text: "To develop new protocols for IoT communication.", correct: false }
        ]
...
const Robotics = [
    {
        ...
        answers: [
            { text: "The study of artificial intelligence and its applications in machines.", correct: false },
            { text: "A branch of engineering focused on the design and development of robots.", correct: true },
            { text: "The practice of creating software for automated systems.", correct: false },
            { text: "A field of medicine dealing with robotic surgeries.", correct: false }
        ]
    },
    {
        question: "What is a robot?",
        answers: [
            { text: "A computer program that performs tasks on the internet.", correct: false },
            { text: "A machine capable of carrying out complex actions automatically.", correct: true },
            { text: "An artificial intelligence system that mimics human behavior.", correct: false },
            { text: "A software application used to control industrial processes.", correct: false }
        ]
    },
    {
        question: "Which of the following is NOT a type of robot based on locomotion?",
        answers: [
    ...
    {
        question: "Which sensor type is commonly used for obstacle detection in mobile robots?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "An open-source middleware for robotics applications", correct: true },
            { text: "A proprietary operating system for industrial robots", correct: false },
            { text: "A programming language specifically designed for robots", correct: false }
        ]
    },
    {
        ...
        answers: [
            ...
            { text: "A psychological concept related to human-like robots", correct: true },
            { text: "A geographic area with high robot population density", correct: false },
            { text: "A term for robots that are prone to malfunction", correct: false }
        ]
    },
    {
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "To provide physical interaction with virtual environments", correct: true },
    ...
    {
        question: "Which type of robot is commonly used for underwater exploration?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "To make decisions and adapt to changing environments", correct: true },
            { text: "To improve mechanical stability", correct: false }
        ]
    },
    {
        question: "Which engineering discipline integrates principles of robotics with biological systems?",
        answers: [
    ...
    {
        question: "Which mathematical concept is fundamental for robot path planning?",
        answers: [
    ...
    {
        question: "Which sensor type is commonly used for distance measurement in robotics?",
        answers: [
...
const Image_Processing = [
    {
        ...
        answers: [
            ...
            { text: "A field of computer science focusing on manipulating digital images.", correct: true },
            { text: "The practice of enhancing physical photographs using chemicals.", correct: false },
            { text: "A branch of electrical engineering dealing with power distribution.", correct: false }
        ]
    },
    {
        question: "Which of the following is NOT a fundamental step in Image Processing?",
        answers: [
    ...
    {
        question: "Which technique is used for removing the background of an image?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "To reduce file size while preserving image quality.", correct: true },
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "To align multiple images into the same coordinate system.", correct: true },
    ...
    {
        question: "Which technique is used for detecting and recognizing faces in images?",
        answers: [
    ...
    {
        question: "What does the term 'Feature Extraction' refer to in Image Processing?",
        answers: [
            { text: "Extracting prominent objects from an image.", correct: false },
            { text: "Identifying key points or patterns in an image.", correct: true },
            { text: "Adjusting color and brightness levels.", correct: false },
            { text: "Transforming images into different file formats.", correct: false }
        ]
    },
    {
    ...
    {
        question: "Which technique is used for converting color images to grayscale?",
        answers: [
            { text: "Histogram matching", correct: false },
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "To convert images between different file formats.", correct: false },
...
const Virtual_Reality = [
    {
        ...
        answers: [
            { text: "A technology for creating 3D models in computer graphics.", correct: false },
            { text: "An artificial environment created by computer-generated simulations.", correct: true },
            { text: "A method for enhancing audio quality in digital media.", correct: false },
            { text: "A technique for encrypting data in virtual environments.", correct: false }
        ]
    },
    {
    ...
    },
    {
        ...
        answers: [
            { text: "To adjust the brightness of virtual environments.", correct: false },
            { text: "To simulate touch sensations for a more immersive experience.", correct: true },
            { text: "To synchronize audio and video streams.", correct: false },
            { text: "To create 3D models from 2D images.", correct: false }
        ]
    },
    {
        question: "Which technology is essential for tracking movement in Virtual Reality?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "Simulating physical presence in remote environments.", correct: true },
            { text: "Creating virtual representations of real-world objects.", correct: false },
            { text: "Analyzing data patterns in virtual simulations.", correct: false },
            { text: "Enhancing visual effects in computer graphics.", correct: false }
        ]
    },
    {
        question: "Which industry commonly uses Virtual Reality for training simulations?",
        answers: [
            { text: "Agriculture", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "To enhance virtual environments with real-world elements.", correct: false },
            { text: "To simulate physical sensations in virtual environments.", correct: false },
            { text: "To project virtual objects onto physical surfaces.", correct: false },
            { text: "To overlay digital information onto the user's view of the real world.", correct: true }
        ]
    },
    {
        question: "Which principle is used to create the illusion of depth in Virtual Reality?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "To display interactive 3D models on web browsers.", correct: false },
            { text: "To create a sense of presence and engagement in virtual environments.", correct: true },
            { text: "To simulate real-world physics in computer simulations.", correct: false },
            { text: "To synchronize multiple users in a shared virtual space.", correct: false }
        ]
    },
    {
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "The sense of being physically present in a virtual environment.", correct: true },
            { text: "The process of creating realistic textures in virtual simulations.", correct: false },
            { text: "The technique for rendering lighting effects in 3D models.", correct: false }
        ]
    },
    {
        question: "Which technology enables wireless communication in Virtual Reality?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "To synchronize audio playback with video frames.", correct: false },
            { text: "To enhance the realism of virtual environments by simulating sound directionality.", correct: true },
            { text: "To compress audio data for efficient transmission.", correct: false },
    ...
    {
        question: "What is the primary advantage of Web-based Virtual Reality applications?",
        answers: [
            { text: "Highly realistic graphics rendering.", correct: false },
            { text: "Cross-platform compatibility without requiring specific hardware.", correct: true },
            { text: "Advanced motion tracking capabilities.", correct: false },
            { text: "Enhanced interaction through haptic feedback.", correct: false }
        ]
    },
    {
        question: "Which concept is central to the development of Social Virtual Reality platforms?",
        answers: [
    ...
    {
        question: "What is the primary challenge in achieving 'Presence' in Virtual Reality?",
        answers: [
            ...
            { text: "Overcoming visual and sensory discrepancies between real and virtual environments", correct: true }
        ]
    },
    {
        question: "Which technology enables real-time collaboration in Virtual Reality?",
        answers: [
    ...
    {
        question: "What is the role of AI (Artificial Intelligence) in Virtual Reality applications?",
        answers: [
            { text: "To simulate physical phenomena in virtual environments.", correct: false },
            { text: "To analyze user behavior and preferences for personalized experiences.", correct: true },
            { text: "To compress and optimize data transmission in VR systems.", correct: false },
            { text: "To synchronize audio and visual cues for immersive storytelling.", correct: false }
        ]
    },
    {
        question: "What does the term 'Cybersickness' refer to in Virtual Reality?",
        answers: [
            { text: "The sensation of vertigo caused by visual motion in VR.", correct: true },
            { text: "The risk of cyber attacks on virtual environments.", correct: false },
            { text: "The process of establishing secure connections in VR networks.", correct: false },
            { text: "The practice of creating virtual replicas of physical objects.", correct: false }
        ]
    }
];
///////////////////////////////////////////// Augmented Reality  ////////////////////////////////////////////////////
const Augmented_Reality = [
    {
        ...
        answers: [
            { text: "A technology that generates 3D models from 2D images.", correct: false },
    ...
    {
        question: "Which device is commonly used for experiencing Augmented Reality?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "To create 3D models from 2D images.", correct: false },
            { text: "To provide reference points for placing digital content in the real world.", correct: true },
            { text: "To synchronize audio and video streams.", correct: false },
            { text: "To store large amounts of digital data.", correct: false }
        ]
    },
    {
        question: "Which technology is essential for tracking movement in Augmented Reality?",
        answers: [
            { text: "RFID (Radio Frequency Identification)", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "AR applications that do not require physical markers to function.", correct: true },
            { text: "AR experiences that are purely virtual and not overlaid on the real world.", correct: false },
            { text: "A method of AR that relies on GPS data exclusively.", correct: false },
            { text: "An AR system that enhances sound rather than visual elements.", correct: false }
        ]
    },
    {
        question: "Which industry commonly uses Augmented Reality for training simulations?",
        answers: [
            { text: "Agriculture", correct: false },
            { text: "Retail", correct: false },
            { text: "Healthcare", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "To create realistic soundscapes for AR environments.", correct: false },
            { text: "To analyze and interpret visual data for overlaying digital content.", correct: true },
            { text: "To compress data for efficient storage.", correct: false },
            { text: "To provide network security for AR applications.", correct: false }
        ]
    },
    {
        question: "Which principle is used to create the illusion of depth in Augmented Reality?",
        answers: [
            { text: "Perspective projection", correct: true },
            { text: "Top-down projection", correct: false },
            { text: "Orthographic projection", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "To display interactive 3D models on web browsers.", correct: false },
            { text: "To enhance the real world with digital elements.", correct: true },
            { text: "To simulate real-world physics in computer simulations.", correct: false },
            { text: "To synchronize multiple users in a shared virtual space.", correct: false }
        ]
    },
    ...
    {
        question: "Which technology enables wireless communication in Augmented Reality?",
        answers: [
            { text: "Bluetooth", correct: true },
            { text: "Ethernet", correct: false },
            { text: "Fiber optics", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "To synchronize audio playback with video frames.", correct: false },
            { text: "To enhance the realism of AR experiences by simulating sound directionality.", correct: true },
            { text: "To compress audio data for efficient transmission.", correct: false },
            { text: "To apply audio effects to speech synthesis.", correct: false }
        ]
    },
    {
        question: "Which rendering technique is commonly used in Augmented Reality?",
        answers: [
            { text: "Rasterization", correct: true },
            { text: "Ray tracing", correct: false },
            { text: "Path tracing", correct: false },
    ...
    {
        question: "What is the primary advantage of Web-based Augmented Reality applications?",
        answers: [
            { text: "Highly realistic graphics rendering.", correct: false },
            { text: "Cross-platform compatibility without requiring specific hardware.", correct: true },
            { text: "Advanced motion tracking capabilities.", correct: false },
    ...
    {
        question: "Which concept is central to the development of Social Augmented Reality platforms?",
        answers: [
            { text: "Geometric modeling", correct: false },
            { text: "Human-computer interaction", correct: false },
            { text: "Avatars and virtual identities", correct: true },
    ...
    {
        question: "What is the primary challenge in achieving 'Presence' in Augmented Reality?",
        answers: [
            { text: "Display resolution limitations", correct: false },
            { text: "Latency in motion tracking", correct: false },
            { text: "Simulating realistic physical interactions", correct: false },
            { text: "Overcoming visual and sensory discrepancies between real and augmented environments", correct: true }
        ]
    },
    {
        question: "Which technology enables real-time collaboration in Augmented Reality?",
        answers: [
            { text: "Internet Protocol (IP) cameras", correct: false },
            { text: "Peer-to-peer networking", correct: false },
            { text: "Cloud computing", correct: false },
    ...
    {
        question: "What is the role of AI (Artificial Intelligence) in Augmented Reality applications?",
        answers: [
            { text: "To simulate physical phenomena in augmented environments.", correct: false },
            { text: "To analyze user behavior and preferences for personalized experiences.", correct: true },
            { text: "To compress and optimize data transmission in AR systems.", correct: false },
            { text: "To synchronize audio and visual cues for immersive storytelling.", correct: false }
        ]
    },
    {
        ...
        answers: [
            { text: "A type of eyewear that enhances vision for low-light conditions.", correct: false },
            { text: "A type of glasses that overlay digital information on the real world.", correct: true },
            { text: "A device for magnifying small objects in scientific research.", correct: false },
            { text: "A protective eyewear used in industrial settings.", correct: false }
        ]
    }
];
/////////////////////////////////////////  Ethical Hacking   ////////////////////////////////////////////////////////
const Ethical_Hacking = [
    {
        ...
        answers: [
            ...
            { text: "The practice of bypassing system security to identify potential data breaches and threats in a legal and legitimate manner.", correct: true },
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "A security exercise to identify vulnerabilities in a system.", correct: true },
    ...
    {
        question: "What does the term 'Vulnerability' mean in the context of cybersecurity?",
        answers: [
    ...
    {
        question: "Which ethical hacking phase involves gathering information about a target system?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "Manipulating individuals to gain confidential information.", correct: true },
            { text: "A technique to build physical infrastructure.", correct: false },
            { text: "The practice of creating social media accounts.", correct: false }
        ]
    },
    {
        question: "What is the primary objective of a Denial of Service (DoS) attack?",
        answers: [
            { text: "To steal sensitive information.", correct: false },
            { text: "To render a system or network unavailable to users.", correct: true },
    ...
    {
        question: "Which term refers to a security flaw found in software or hardware?",
        answers: [
    ...
    {
        question: "Which technique involves guessing passwords by trying many possible combinations?",
        answers: [
            { text: "Phishing", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "Vulnerabilities in SQL databases to execute malicious SQL statements.", correct: true },
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "A vulnerability that is unknown to those who should be interested in its mitigation.", correct: true },
            { text: "A type of social engineering attack.", correct: false },
            { text: "A firewall configuration error.", correct: false }
        ]
    },
    {
        question: "Which organization is responsible for creating and managing the Common Vulnerabilities and Exposures (CVE) list?",
        answers: [
            { text: "Microsoft", correct: false },
            { text: "Google", correct: false },
    ...
    {
        question: "What is the purpose of ethical hacking certifications like CEH (Certified Ethical Hacker)?",
        answers: [
            { text: "To certify individuals to conduct illegal hacking activities.", correct: false },
            { text: "To validate the skills and knowledge of professionals in identifying and addressing security threats.", correct: true },
            { text: "To provide legal advice to hacking victims.", correct: false },
            { text: "To teach software development.", correct: false }
        ]
    },
    {
        question: "Which phase of ethical hacking involves fixing the vulnerabilities found?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "Sending an email that appears to be from a trusted source to trick the recipient into revealing sensitive information.", correct: true },
...
const DataBase = [
    {
        ...
        answers: [
            { text: "A collection of data stored in a computer system.", correct: true },
            { text: "A programming language.", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "A key that uniquely identifies a record in a table.", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "A key that uniquely identifies a record in a table.", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "The process of reducing redundancy and dependency by organizing fields and table of a database.", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "A sequence of operations performed as a single logical unit of work.", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "A virtual table based on the result-set of an SQL statement.", correct: true },
            { text: "A backup of the database.", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "A database object that improves the speed of data retrieval.", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "A SQL operation that combines rows from two or more tables.", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "A precompiled collection of one or more SQL statements stored in the database.", correct: true },
            { text: "A backup of the database.", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "A set of actions that are automatically performed in response to a certain event.", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "To group rows that have the same values into summary rows.", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "To filter groups based on a specified condition.", correct: true },
...
const MongoDB = [
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "A group of mongod processes that maintain the same data set", correct: true },
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "A method for distributing data across multiple machines", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "A document that contains a reference to another document", correct: false },
            { text: "A document that is nested within another document", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "Collections are created automatically when a document is inserted", correct: true },
...
const Basic_Electronics = [
    {
        ...
        answers: [
            { text: "The relationship between voltage, current, and resistance", correct: true },
            { text: "The principle of electromagnetic induction", correct: false },
            { text: "The law of conservation of energy", correct: false },
            { text: "The relationship between power, voltage, and current", correct: false }
        ]
    },
    {
    ...
    },
    {
        ...
        answers: [
            { text: "A material with very high electrical conductivity", correct: false },
            { text: "A material with electrical conductivity between a conductor and an insulator", correct: true },
            { text: "A material with no electrical conductivity", correct: false },
            { text: "A material that converts electrical energy into light", correct: false }
        ]
    },
    {
    ...
    },
    {
        ...
        answers: [
            { text: "The total current entering a junction equals the total current leaving", correct: false },
            { text: "The sum of all voltages around a closed loop equals zero", correct: true },
            { text: "The relationship between voltage, current, and resistance", correct: false },
            { text: "The power consumed in a circuit is equal to the power supplied", correct: false }
        ]
    },
    {
    ...
    },
    {
        ...
        answers: [
            { text: "To store electrical energy in an electric field", correct: false },
    ...
    {
        question: "Which of the following is a characteristic of an ideal operational amplifier?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "Applying a voltage or current to set the operating point of a component", correct: true },
...
const Electromagnetic_Theory = [
    {
        ...
        answers: [
            { text: "The principle that states the electric flux through a closed surface is proportional to the charge enclosed", correct: true },
            { text: "The law that relates magnetic fields and electric currents", correct: false },
            { text: "The principle that states the total current entering a junction equals the total current leaving", correct: false },
            { text: "The law that states the induced EMF is proportional to the rate of change of magnetic flux", correct: false }
        ]
    },
    {
        ...
        answers: [
            { text: "The principle that states the total current entering a junction equals the total current leaving", correct: false },
            { text: "The law that states the induced EMF is proportional to the rate of change of magnetic flux", correct: true },
            { text: "The principle that states the electric flux through a closed surface is proportional to the charge enclosed", correct: false },
            { text: "The law that relates magnetic fields and electric currents", correct: false }
        ]
    },
    {
    ...
    },
    {
        ...
        answers: [
            { text: "The total current entering a junction equals the total current leaving", correct: false },
            { text: "The line integral of the magnetic field around a closed loop is proportional to the current enclosed", correct: true },
            { text: "The induced EMF is proportional to the rate of change of magnetic flux", correct: false },
            { text: "The electric flux through a closed surface is proportional to the charge enclosed", correct: false }
        ]
    },
    {
    ...
    },
    {
        ...
        answers: [
            { text: "To describe the behavior of electric and magnetic fields", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "The total electric field due to multiple charges is the vector sum of the individual fields", correct: true },
            { text: "The induced EMF is proportional to the rate of change of magnetic flux", correct: false },
            { text: "The electric flux through a closed surface is proportional to the charge enclosed", correct: false },
            { text: "The line integral of the magnetic field around a closed loop is proportional to the current enclosed", correct: false }
        ]
    },
    {
        question: "What is an electric dipole?",
        answers: [
            { text: "A pair of equal and opposite charges separated by a distance", correct: true },
            { text: "A single charge in an electric field", correct: false },
            { text: "A pair of like charges separated by a distance", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "A vector representing the direction and magnitude of electromagnetic energy flow", correct: true },
            { text: "A vector representing the magnetic field strength", correct: false },
            { text: "A vector representing the electric field strength", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "The direction of the induced EMF and current will oppose the change in magnetic flux", correct: true },
            { text: "The electric flux through a closed surface is proportional to the charge enclosed", correct: false },
            { text: "The total current entering a junction equals the total current leaving", correct: false },
            { text: "The induced EMF is proportional to the rate of change of magnetic flux", correct: false }
        ]
    ...
    },
    {
        ...
        answers: [
            { text: "The transmission of electromagnetic energy through space", correct: true },
            { text: "The reflection of electromagnetic waves off surfaces", correct: false },
            { text: "The absorption of electromagnetic waves by materials", correct: false },
            { text: "The generation of electromagnetic waves by antennas", correct: false }
        ]
    },
    {
        question: "What is Coulomb's Law?",
        answers: [
            { text: "The force between two point charges is directly proportional to the product of their charges and inversely proportional to the square of the distance between them", correct: true },
            { text: "The electric flux through a closed surface is proportional to the charge enclosed", correct: false },
            { text: "The total current entering a junction equals the total current leaving", correct: false },
            { text: "The line integral of the magnetic field around a closed loop is proportional to the current enclosed", correct: false }
        ]
    },
    {
        ...
        answers: [
            { text: "To classify electromagnetic waves by their frequency or wavelength", correct: true },
            { text: "To measure the strength of magnetic fields", correct: false },
            { text: "To convert AC to DC", correct: false },
            { text: "To relate electric current to voltage", correct: false }
        ]
    },
    {
        ...
        answers: [
            { text: "Electromagnetic waves exhibit both wave-like and particle-like properties", correct: true },
            { text: "The speed of light is constant in a vacuum", correct: false },
            { text: "The total electric field due to multiple charges is the vector sum of the individual fields", correct: false },
            { text: "The force between two point charges is directly proportional to the product of their charges", correct: false }
        ]
    },
    {
        question: "What is the skin effect?",
        answers: [
            { text: "The tendency of AC current to distribute within a conductor so that the current density is largest near the surface", correct: true },
            { text: "The force between two point charges", correct: false },
            { text: "The total electric field due to multiple charges", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "To describe the behavior of electric and magnetic fields at the interface of two different media", correct: true },
            { text: "To measure the strength of magnetic fields", correct: false },
            { text: "To convert AC to DC", correct: false },
            { text: "To relate electric current to voltage", correct: false }
        ]
...
const Signal_and_System = [
    {
        ...
        answers: [
            { text: "A signal that is defined only at discrete times", correct: false },
            { text: "A signal that is defined for every instant of time", correct: true },
            { text: "A signal that is only defined for integer values", correct: false },
            { text: "A signal that is periodic with a fixed interval", correct: false }
        ]
    },
    {
        question: "What is a discrete-time signal?",
        answers: [
            { text: "A signal that is defined for every instant of time", correct: false },
            { text: "A signal that is defined only at discrete times", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "A function that is zero everywhere except at one point where it is infinite", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "Converting a time-domain signal into its frequency-domain representation", correct: true },
            { text: "Sampling a continuous-time signal", correct: false },
            { text: "Converting a discrete-time signal into a continuous-time signal", correct: false },
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "A system that is non-linear and time-invariant", correct: false }
        ]
    },
    {
        question: "What is convolution?",
        answers: [
            { text: "A mathematical operation used to determine the output of an LTI system", correct: true },
            { text: "A process of sampling a continuous-time signal", correct: false },
            { text: "A method to transform a signal into its frequency components", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "A system where the output depends only on past and present inputs", correct: true },
            { text: "A system where the output depends on future inputs", correct: false },
            { text: "A system where the output is independent of the input", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "The process of converting a continuous-time signal into a discrete-time signal", correct: true },
            { text: "The process of converting a discrete-time signal into a continuous-time signal", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "The distortion that occurs when a signal is undersampled", correct: true },
            { text: "The process of converting a signal from time-domain to frequency-domain", correct: false },
            { text: "The technique used to remove noise from a signal", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "The minimum sampling rate required to avoid aliasing", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "A filter that allows frequencies within a certain range to pass", correct: true },
            { text: "A filter that blocks all frequencies", correct: false },
            { text: "A filter that allows all frequencies to pass", correct: false },
            { text: "A filter that allows only a single frequency to pass", correct: false }
        ]
    },
    {
        question: "What is the impulse response of a system?",
        answers: [
            { text: "The output of a system when the input is an impulse signal", correct: true },
            { text: "The input required to produce a constant output", correct: false },
            { text: "The output of a system when the input is a sinusoidal signal", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "To represent a periodic signal as a sum of sinusoids", correct: true },
            { text: "To convert a signal into its Laplace transform", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "The range of frequencies over which the signal is defined", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "A signal that is symmetric about the vertical axis", correct: true },
            { text: "A signal that is symmetric about the horizontal axis", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "A signal that is antisymmetric about the vertical axis", correct: true },
            { text: "A signal that is symmetric about the vertical axis", correct: false },
            { text: "A signal that is periodic", correct: false },
            { text: "A signal that is non-periodic", correct: false }
        ]
    }
...
const Digital_Electronics = [
    {
        ...
        answers: [
            { text: "A device that performs logical operations on one or more binary inputs", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "The time taken for a signal to travel from input to output", correct: true },
            { text: "The time taken for a signal to reach its maximum amplitude", correct: false },
            { text: "The time taken for a signal to be stored in memory", correct: false },
    ...
    {
        question: "What is the primary difference between synchronous and asynchronous circuits?",
        answers: [
...
const Microprocessor_and_Microcontroller = [
    {
        ...
        answers: [
            ...
            { text: "A central processing unit on a single integrated circuit", correct: true },
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "To control embedded systems and perform specific tasks", correct: true },
    ...
    {
        question: "Which register in a microprocessor holds the address of the next instruction to be executed?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "A signal that temporarily halts the CPU's current activities", correct: true },
    ...
    {
        question: "What is the role of an ALU (Arithmetic Logic Unit) in a microprocessor?",
        answers: [
            { text: "To perform arithmetic and logical operations", correct: true },
            { text: "To store data", correct: false },
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "Simple instructions that can be executed in a single clock cycle", correct: true },
    ...
    {
        question: "What is the main difference between a microprocessor and a microcontroller?",
        answers: [
            { text: "A microprocessor has built-in memory and I/O ports", correct: false },
            { text: "A microcontroller has built-in memory and I/O ports", correct: true },
            { text: "A microprocessor is used for specific tasks", correct: false },
            { text: "A microcontroller is used for general-purpose computing", correct: false }
        ]
    },
    {
        ...
        answers: [
            ...
            { text: "A computer system with a dedicated function within a larger system", correct: true },
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "A type of non-volatile memory used for storing firmware", correct: true },
            { text: "A type of cache memory", correct: false },
            { text: "A type of memory used for temporary data storage", correct: false }
        ]
    },
    {
        question: "Which instruction set architecture is widely used in ARM microprocessors?",
        answers: [
    ...
    {
        question: "Which company developed the first microprocessor, the Intel 4004?",
        answers: [
...
const Arduino = [
    {
        ...
        answers: [
            ...
            { text: "An open-source electronics platform based on easy-to-use hardware and software", correct: true },
    ...
    {
        question: "Which IDE (Integrated Development Environment) is commonly used for Arduino programming?",
        answers: [
    ...
    {
        question: "What is the function of the 'setup()' function in Arduino sketches?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "An add-on board that extends Arduino's capabilities", correct: true },
            { text: "A programming language used with Arduino", correct: false }
        ]
    },
    {
        question: "What is the function of the 'loop()' function in Arduino sketches?",
        answers: [
    ...
    {
        question: "Which communication protocol is commonly used with Arduino for serial communication?",
        answers: [
    ...
    {
        question: "Which component converts digital signals to analog signals in Arduino?",
        answers: [
    ...
    {
        question: "What is the maximum number of digital pins on an Arduino Uno board?",
        answers: [
    ...
    {
        question: "What is the purpose of the 'delay()' function in Arduino sketches?",
        answers: [
            { text: "To synchronize data transmission", correct: false },
            { text: "To generate interrupts", correct: false },
            { text: "To pause the program execution for a specified time", correct: true },
            { text: "To read sensor values", correct: false }
        ]
    },
    {
        question: "What is the maximum current that can be drawn from a single I/O pin on an Arduino Uno board?",
        answers: [
    ...
    {
        question: "Which of the following is a benefit of using Arduino for IoT (Internet of Things) projects?",
        answers: [
            { text: "Limited connectivity options", correct: false },
            { text: "Complex programming requirements", correct: false },
            { text: "Wide range of sensor integration and community support", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "To write analog signals to output pins using PWM", correct: true },
...
const Sensors = [
    {
        ...
        answers: [
            ...
            { text: "A device that detects or measures physical properties and converts them into signals", correct: true },
    ...
    {
        question: "Which sensor is used to detect the presence or absence of an object?",
        answers: [
    ...
    {
        question: "Which sensor is used in smart lighting systems to adjust brightness based on ambient light?",
        answers: [
            { text: "Temperature sensor", correct: false },
...
const Power_Electronics = [
    {
        ...
        answers: [
            { text: "A branch of electronics dealing with low power circuits", correct: false },
            { text: "A field that deals with the conversion and control of electric power", correct: true },
            { text: "An area of study focused on digital circuits", correct: false },
            { text: "The study of electromagnetic fields", correct: false }
        ]
    },
    {
        question: "Which device is commonly used as a switch in power electronic circuits?",
        answers: [
            { text: "Resistor", correct: false },
    ...
    {
        question: "Which device is used for overcurrent protection in power circuits?",
        answers: [
            { text: "Inductor", correct: false },
    ...
    {
        question: "Which type of converter is suitable for high-voltage applications?",
        answers: [
            { text: "Boost converter", correct: false },
            { text: "Flyback converter", correct: false },
    ...
    {
        question: "What is the primary advantage of using IGBTs (Insulated Gate Bipolar Transistors) in power electronics?",
        answers: [
    ...
    {
        question: "Which semiconductor device is commonly used for voltage regulation in power supplies?",
        answers: [
    ...
    {
        question: "Which type of power converter is used for isolating input and output circuits?",
        answers: [
            { text: "Boost converter", correct: false },
    ...
    {
        question: "Which parameter is critical for selecting a capacitor in power electronics?",
        answers: [
    ...
    {
        question: "What is the function of a freewheeling diode in power electronic circuits?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "MOSFET (Metal-Oxide-Semiconductor Field-Effect Transistor)", correct: true },
            { text: "IGBT (Insulated Gate Bipolar Transistor)", correct: false },
            { text: "SCR (Silicon Controlled Rectifier)", correct: false }
        ]
    },
    {
        question: "What is the primary disadvantage of using SCR (Silicon Controlled Rectifier) in power electronics?",
        answers: [
    ...
    {
        question: "Which type of power converter is used for generating high-frequency AC signals?",
        answers: [
    ...
    {
        question: "What is the primary function of a flyback transformer in power supplies?",
        answers: [
...
const VLSI = [
    ...
    {
        question: "Which company is known for pioneering the first microprocessor using VLSI technology?",
        answers: [
            { text: "Intel", correct: true },
            { text: "AMD", correct: false },
    ...
    {
        question: "Which programming language is often used for writing VLSI testbenches?",
        answers: [
            { text: "Java", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "To amplify signals", correct: false },
            { text: "To perform arithmetic operations", correct: false },
            { text: "To select one of several inputs based on a control signal", correct: true },
            { text: "To store data temporarily", correct: false }
        ]
    },
    {
        question: "Which process is used for embedding multiple layers of interconnects in VLSI fabrication?",
        answers: [
    ...
    {
        question: "Which parameter is critical for reducing power consumption in VLSI circuits?",
        answers: [
    ...
    {
        question: "What is the purpose of clock skew optimization in VLSI circuits?",
        answers: [
            { text: "To synchronize input signals", correct: false },
            { text: "To reduce power consumption", correct: false },
            { text: "To minimize timing delays between clock signals", correct: true },
            { text: "To increase circuit density", correct: false }
        ]
    },
    {
        question: "Which type of simulation is used for verifying VLSI designs before fabrication?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "To amplify signals", correct: false },
            { text: "To isolate high-current sections from low-current sections", correct: true },
            { text: "To store data temporarily", correct: false }
        ]
    },
    {
        question: "Which technology node represents smaller feature sizes in VLSI fabrication?",
        answers: [
    ...
    {
        question: "What is the main advantage of ASIC (Application-Specific Integrated Circuit) in VLSI design?",
        answers: [
    ...
    {
        question: "Which technique is used for reducing crosstalk in VLSI interconnects?",
        answers: [
...
const Control_System = [
    {
        ...
        answers: [
            ...
            { text: "A system that regulates the behavior of other systems or devices", correct: true },
            { text: "A system that controls access to computer networks", correct: false },
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "The return of part of the output signal to the input", correct: true },
            { text: "A mechanism for reporting errors in computer programs", correct: false },
            { text: "A tool for managing customer complaints", correct: false }
        ]
    },
    {
        question: "Which of the following is a characteristic of a closed-loop control system?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "To regulate industrial processes based on proportional, integral, and derivative actions", correct: true },
            { text: "To encrypt data transmitted over networks", correct: false },
            { text: "To manage personal identification numbers in security systems", correct: false }
        ]
    },
    {
        question: "What is the steady-state error in a control system?",
        answers: [
            { text: "The error that occurs when the system is first turned on", correct: false },
            { text: "The error that persists after the system has stabilized", correct: true },
            { text: "The error caused by noise in sensor readings", correct: false },
            { text: "The error in data transmission between computers", correct: false }
        ]
    },
    {
        ...
        answers: [
            ...
            { text: "The relationship between the input and output signals", correct: true },
            { text: "The steps involved in controlling a process", correct: false },
            { text: "The protocols used for communication between devices", correct: false }
        ]
    },
    {
        question: "Which type of control system is characterized by a fixed set of rules?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "To convert control signals into physical actions", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "To determine the frequency response of a system", correct: true },
            { text: "To select optimal PID controller gains", correct: false },
            { text: "To calculate the transfer function of a system", correct: false },
            { text: "To predict steady-state errors in closed-loop systems", correct: false }
        ]
    },
    {
        question: "What is meant by 'stability' in control systems?",
        answers: [
            { text: "The ability of a system to achieve desired performance", correct: false },
            { text: "The resistance of a system to external disturbances", correct: false },
            { text: "The absence of oscillations or unbounded growth in the system's response", correct: true },
            { text: "The accuracy of sensor readings in the system", correct: false }
        ]
    },
    {
        question: "Which control system design method emphasizes graphical representation of system behavior?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "To convert physical quantities into electrical signals", correct: true },
            ...
            { text: "To regulate the flow of data between subsystems", correct: false }
        ]
    },
    {
        question: "Which type of controller adjusts its parameters based on system behavior?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "The duration of system operation before maintenance is required", correct: false },
            { text: "The time taken for a system to achieve a steady-state response", correct: false },
            { text: "The time delay between input signal changes and system response", correct: true },
            { text: "The frequency of periodic signal oscillations in the system", correct: false }
        ]
    },
    {
        question: "Which type of control system is used for automated manufacturing processes?",
        answers: [
    ...
    {
        question: "What is the primary function of a compensator in control systems?",
        answers: [
            { text: "To monitor system performance metrics", correct: false },
            { text: "To correct errors in sensor readings", correct: false },
            { text: "To adjust the dynamics of a system to meet desired specifications", correct: true },
            { text: "To regulate power supply voltages", correct: false }
        ]
    },
    {
        question: "Which control system design approach focuses on the analysis of poles and zeros in the s-domain?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "The response of the system after it has settled to a constant value", correct: true },
            { text: "The dynamic response of the system to input changes", correct: false },
            { text: "The stability analysis of the control loop", correct: false }
        ]
    },
    {
        question: "Which type of controller is commonly used for on-off control applications?",
        answers: [
...
const Circuit_Theory = [
    ...
    },
    {
        ...
        answers: [
            { text: "To analyze the current flowing through a circuit", correct: false },
            { text: "To calculate the power dissipation in resistors", correct: false },
            { text: "To determine the total resistance of a circuit", correct: false },
            { text: "To analyze the voltages in a closed loop circuit", correct: true }
        ]
    },
    {
        question: "What is the unit of electrical resistance?",
    ...
    {
        question: "Which law states that the total current entering a node is equal to the total current leaving the node?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "The relationship between voltage and current in a resistor", correct: true },
    ...
    {
        question: "Which component is used to control the flow of current between two terminals?",
        answers: [
            { text: "Resistor", correct: false },
            { text: "Capacitor", correct: false },
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "The frequency at which a circuit absorbs maximum power", correct: true },
            { text: "The resistance of a circuit to changes in current", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "AC flows in one direction only, while DC changes direction periodically", correct: false },
            { text: "AC changes direction periodically, while DC flows in one direction only", correct: true },
            { text: "AC is used for digital circuits, while DC is used for analog circuits", correct: false },
            { text: "AC is safer to use in residential buildings, while DC is used in industrial settings", correct: false }
        ]
    },
    {
        question: "Which law states that the voltage across a resistor is proportional to the current flowing through it?",
        answers: [
            { text: "Faraday's Law", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "The ability of a circuit to generate electrical energy", correct: false },
            { text: "The total resistance of a circuit", correct: false },
            { text: "The combination of resistance, inductance, and capacitance in AC circuits", correct: true },
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "To protect the circuit from overcurrent conditions", correct: true },
            { text: "To amplify electrical signals", correct: false }
        ]
    },
    {
    ...
    },
    {
        ...
        answers: [
            { text: "The efficiency of a circuit in converting electrical energy into heat", correct: false },
            { text: "The ratio of true power to apparent power in AC circuits", correct: true },
            { text: "The ability of a circuit to handle high voltage spikes", correct: false },
            { text: "The resistance of a circuit to changes in current", correct: false }
        ]
    },
    {
    ...
    {
        question: "Which law governs the conservation of energy in electrical circuits?",
        answers: [
            { text: "Ohm's Law", correct: false },
            { text: "Kirchhoff's Voltage Law (KVL)", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "The process of connecting a circuit to a power source", correct: false },
            { text: "The protection of circuits from lightning strikes", correct: false },
            { text: "The connection of a circuit to the Earth to prevent electrical hazards", correct: true },
...
const Analog_Electronics = [
    {
        question: "What is the primary function of a transistor in analog circuits?",
        answers: [
            { text: "To store data temporarily", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "The range of frequencies over which a device operates effectively", correct: true },
            { text: "The total resistance in a circuit", correct: false },
            { text: "The maximum power handling capacity of a transistor", correct: false },
            { text: "The speed of data transmission in digital circuits", correct: false }
        ]
    },
    {
    ...
    {
        question: "Which circuit component is used to stabilize voltage levels in power supplies?",
        answers: [
            { text: "Inductor", correct: false },
            { text: "Resistor", correct: false },
            { text: "Zener diode", correct: true },
    ...
    {
        question: "What is the purpose of an operational amplifier (op-amp) in analog circuits?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "The ability of a circuit to generate oscillations", correct: true },
            { text: "The process of converting digital signals to analog signals", correct: false },
            { text: "The resistance offered by a circuit to the flow of current", correct: false },
            { text: "The capacity of a capacitor to store electrical charge", correct: false }
        ]
    },
    {
        question: "What is the primary purpose of a transformer in analog circuits?",
        answers: [
            { text: "To regulate voltage levels", correct: true },
            { text: "To amplify electrical signals", correct: false },
            { text: "To convert DC to AC power", correct: false },
            { text: "To protect against electromagnetic interference", correct: false }
        ]
    },
    {
        question: "Which type of filter is used to pass only certain frequencies and block others?",
        answers: [
    ...
    {
        question: "What is the primary function of a voltage regulator in analog circuits?",
        answers: [
            { text: "To amplify voltage signals", correct: false },
    ...
    {
        question: "What is the purpose of a crystal oscillator in analog electronics?",
        answers: [
            { text: "To amplify electrical signals", correct: false },
            { text: "To generate clock signals with precise frequencies", correct: true },
            { text: "To regulate voltage levels", correct: false },
            { text: "To convert digital signals to analog signals", correct: false }
        ]
    },
    {
        question: "Which component is used to protect circuits from excessive current?",
        answers: [
    ...
    {
        question: "What is the primary function of a potentiometer in analog circuits?",
        answers: [
            { text: "To measure current flow", correct: false },
    ...
    {
        question: "Which characteristic of a capacitor determines its ability to store charge?",
        answers: [
    ...
    {
        question: "Which characteristic of an inductor affects its ability to store energy?",
        answers: [
            { text: "Resistance", correct: false },
...
const Embedded_Systems = [
    {
        question: "What is an embedded system?",
        answers: [
            { text: "A software application that runs on a personal computer", correct: false },
            { text: "A computer system with a dedicated function within a larger mechanical or electrical system", correct: true },
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "It uses an operating system like Windows or macOS", correct: false }
        ]
    },
    {
        ...
        answers: [
            ...
            { text: "To control specific functions within the system", correct: true },
            { text: "To provide graphical output", correct: false },
            { text: "To manage network connections", correct: false }
        ]
    },
    {
        question: "Which programming language is commonly used in embedded systems?",
        answers: [
            { text: "JavaScript", correct: false },
            { text: "Python", correct: false },
            { text: "C", correct: true },
    ...
    {
        question: "What is the primary advantage of using an RTOS in an embedded system?",
        answers: [
            { text: "It provides a graphical user interface", correct: false },
            { text: "It ensures real-time task scheduling and execution", correct: true },
    ...
    {
        question: "Which of the following is a common communication protocol used in embedded systems?",
        answers: [
            { text: "HTTP", correct: false },
    ...
    {
        question: "Which of the following is NOT a type of memory used in embedded systems?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "To monitor and reset the system in case of a fault", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "A program that loads and starts the main operating system", correct: true },
    ...
    {
        question: "Which of the following is an example of a real-time operating system (RTOS)?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "A signal that causes the processor to stop and perform a specific task", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "Software designed to manage hardware operations", correct: true },
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "To measure and convert physical parameters to electrical signals", correct: true },
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "To ensure stable signal reading from mechanical switches", correct: true },
...
const Communication_Systems = [
    {
        ...
        answers: [
            { text: "To store data securely", correct: false },
            { text: "To transmit information from one place to another", correct: true },
            { text: "To perform calculations quickly", correct: false },
            { text: "To control mechanical systems", correct: false }
        ]
    },
    {
        question: "Which of the following is a type of modulation used in analog communication?",
        answers: [
    ...
    {
        question: "What is the purpose of a carrier signal in communication systems?",
        answers: [
            { text: "To amplify the information signal", correct: false },
            { text: "To carry the information signal over long distances", correct: true },
            { text: "To filter out noise", correct: false },
            { text: "To convert analog signals to digital signals", correct: false }
        ]
    },
    {
        question: "Which device is used to convert analog signals to digital signals?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "The range of frequencies that a communication channel can transmit", correct: true },
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "To extract the information signal from the carrier signal", correct: true },
    ...
    {
        question: "Which of the following is a type of noise in communication systems?",
        answers: [
    ...
    {
        question: "What is the main advantage of digital communication over analog communication?",
        answers: [
    ...
    {
        question: "Which communication technique uses multiple frequencies to transmit multiple signals simultaneously?",
        answers: [
            { text: "Time Division Multiplexing (TDM)", correct: false },
    ...
    {
        question: "What is the purpose of error detection and correction in communication systems?",
        answers: [
    ...
    {
        question: "What is an antenna's primary function in a communication system?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "To increase the power of the transmitted signal", correct: false },
            { text: "To combine multiple signals into one for transmission", correct: true },
            { text: "To convert analog signals to digital signals", correct: false },
            { text: "To amplify received signals", correct: false }
        ]
    },
    {
        question: "Which of the following is a disadvantage of wireless communication?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "The process of amplifying a signal", correct: false },
            { text: "The process of varying a carrier signal to transmit information", correct: true },
            { text: "The process of filtering out noise", correct: false },
            { text: "The process of converting digital signals to analog signals", correct: false }
        ]
    },
    {
        question: "Which type of modulation is used in Frequency Modulation (FM) radio?",
        answers: [
    ...
    {
        question: "What is the primary purpose of a repeater in a communication system?",
        answers: [
            { text: "To store data", correct: false },
...
const Microwave_Engineering = [
    ...
    {
        question: "What is the primary application of a waveguide in microwave engineering?",
        answers: [
            { text: "To store energy", correct: false },
            { text: "To amplify signals", correct: false },
            { text: "To transmit microwaves from one point to another", correct: true },
            { text: "To filter signals", correct: false }
        ]
    },
    {
        question: "Which type of modulation is commonly used in microwave communication?",
        answers: [
            { text: "Amplitude Modulation (AM)", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "To amplify signals", correct: false },
            { text: "To convert AC to DC", correct: false },
            { text: "To direct microwave signals in a specific direction", correct: true },
            { text: "To generate microwaves", correct: false }
        ]
    },
    {
        question: "Which material is commonly used for microwave circuit substrates?",
        answers: [
    ...
    {
        question: "What is the primary purpose of a magnetron in microwave engineering?",
        answers: [
    ...
    {
        question: "What is a scalar network analyzer used for in microwave engineering?",
        answers: [
            { text: "To measure voltage levels", correct: false },
            { text: "To measure scalar (magnitude) properties of microwave components", correct: true },
    ...
    {
        question: "What is the typical use of a directional coupler in microwave systems?",
        answers: [
    ...
    {
        question: "Which component is used to measure the power of microwave signals?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "To allow signal transmission in one direction only", correct: true },
            { text: "To filter microwave signals", correct: false }
        ]
    },
    {
        question: "What is the advantage of using a microstrip line in microwave circuits?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "The frequency below which the waveguide cannot support a propagating mode", correct: true },
            { text: "The frequency at which the waveguide is most efficient", correct: false },
            { text: "The frequency above which the waveguide cannot support a propagating mode", correct: false }
        ]
    },
    {
        question: "Which phenomenon causes signal attenuation in microwave communication?",
        answers: [
    ...
    {
        question: "What is the primary use of a parabolic reflector in microwave communication?",
        answers: [
            { text: "To filter microwave signals", correct: false },
            { text: "To amplify microwave signals", correct: false },
...
const Wireless_Communications = [
    {
        question: "What is the main purpose of a base station in wireless communication?",
        answers: [
            { text: "To store data", correct: false },
            { text: "To amplify signals", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "Amplitude Modulation (AM)", correct: false },
            { text: "Frequency Modulation (FM)", correct: false },
            { text: "Orthogonal Frequency Division Multiplexing (OFDM)", correct: true },
            { text: "Phase Modulation (PM)", correct: false }
        ]
    },
    {
        question: "What is the primary function of an antenna in wireless communication?",
        answers: [
            { text: "To store electrical energy", correct: false },
            { text: "To convert electrical signals to radio waves and vice versa", correct: true },
            { text: "To amplify signals", correct: false },
            { text: "To regulate current flow", correct: false }
        ]
    },
    {
        question: "Which technology is used for short-range wireless communication between devices?",
        answers: [
            { text: "Bluetooth", correct: true },
    ...
    {
        question: "What is the main advantage of using multiple-input multiple-output (MIMO) technology?",
        answers: [
    ...
    {
        question: "Which type of modulation is used in Wi-Fi 6 (802.11ax) for improved efficiency?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "To increase signal strength", correct: false },
            { text: "To transfer an ongoing call or data session from one cell to another", correct: true },
    ...
    {
        question: "Which frequency band is primarily used for 5G millimeter wave (mmWave) communication?",
        answers: [
    ...
    {
        question: "What is the main purpose of the Global System for Mobile Communications (GSM)?",
        answers: [
    ...
    {
        question: "Which protocol is used for secure communication over wireless networks?",
        answers: [
            { text: "HTTP", correct: false },
            { text: "FTP", correct: false },
    ...
    {
        question: "What is the primary advantage of using Frequency Division Duplex (FDD) over Time Division Duplex (TDD)?",
        answers: [
    ...
    {
        question: "Which technology is used to extend the range of wireless networks?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "To control and route data between base stations and external networks", correct: true },
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "To increase data rates by combining multiple frequency bands", correct: true },
            { text: "To enhance security", correct: false },
            { text: "To simplify network design", correct: false }
        ]
    },
    {
        question: "Which multiple access technique is used in CDMA (Code Division Multiple Access)?",
        answers: [
...
const Optical_Communication = [
    {
        question: "What is the primary advantage of using optical fibers for communication?",
        answers: [
            { text: "Lower cost", correct: false },
    ...
    {
        question: "What is the core function of an optical transmitter in a fiber optic communication system?",
        answers: [
            { text: "To convert electrical signals to optical signals", correct: true },
            { text: "To amplify optical signals", correct: false },
            { text: "To store data", correct: false },
            { text: "To convert optical signals to electrical signals", correct: false }
        ]
    },
    {
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "The reduction of signal strength as it travels through the fiber", correct: true },
    ...
    {
        question: "Which phenomenon causes light to be confined within the core of an optical fiber?",
        answers: [
            { text: "Reflection", correct: false },
    ...
    {
        question: "What is the typical wavelength range used for optical communication?",
        answers: [
    ...
    {
        question: "What type of optical fiber has a large core and supports multiple modes of light propagation?",
        answers: [
    ...
    {
        question: "Which component is used to split or combine optical signals in a fiber optic network?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "The spreading of light pulses due to different wavelengths traveling at different speeds", correct: true },
    ...
    {
        question: "What is the main function of a photodetector in an optical communication system?",
        answers: [
            { text: "To amplify optical signals", correct: false },
            { text: "To convert optical signals to electrical signals", correct: true },
            { text: "To store optical data", correct: false },
            { text: "To modulate optical signals", correct: false }
        ]
    },
    {
        question: "What type of laser is commonly used in optical communication systems?",
        answers: [
    ...
    {
        question: "Which type of optical fiber has a small core and supports only a single mode of light propagation?",
        answers: [
    ...
    {
        question: "What is the main disadvantage of multi-mode fibers compared to single-mode fibers?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "To convert optical signals to electrical signals", correct: false },
            { text: "To amplify optical signals directly without converting them to electrical signals", correct: true },
            { text: "To modulate optical signals", correct: false },
            { text: "To split optical signals", correct: false }
        ]
    },
    {
        question: "Which component is used to control the intensity, phase, or polarization of light in optical communication?",
        answers: [
    ...
    {
        question: "What is Wavelength Division Multiplexing (WDM) in optical communication?",
        answers: [
            { text: "A technique to amplify optical signals", correct: false },
            { text: "A method to convert optical signals to electrical signals", correct: false },
            { text: "A method to combine multiple wavelengths of light into a single fiber", correct: true },
            { text: "A technique to split optical signals", correct: false }
        ]
    },
    {
        question: "What is the main advantage of using optical communication over traditional copper wires?",
        answers: [
            { text: "Lower cost", correct: false },
            { text: "Higher bandwidth and longer transmission distances", correct: true },
            { text: "Ease of installation", correct: false },
            { text: "Lower power consumption", correct: false }
        ]
    }
...
const Mobile_Communication = [
    {
        ...
        answers: [
            ...
            { text: "To enable wireless voice and data communication", correct: true },
            { text: "To facilitate wired internet access", correct: false },
            { text: "To provide landline telephone services", correct: false }
        ]
    },
    {
        question: "Which generation of mobile communication introduced digital cellular networks?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "To identify and authenticate the user to the network", correct: true },
    ...
    },
    {
        ...
        answers: [
            { text: "The process of switching from one cell to another", correct: true },
    ...
    {
        question: "Which protocol is used for data transmission in mobile networks?",
        answers: [
            { text: "HTTP", correct: false },
            { text: "FTP", correct: false },
    ...
    {
        question: "What is the primary function of an antenna in mobile communication?",
        answers: [
            { text: "To amplify signals", correct: false },
            { text: "To transmit and receive electromagnetic waves", correct: true },
            { text: "To convert digital signals to analog", correct: false },
    ...
    {
        question: "Which mobile communication standard supports both data and voice services?",
        answers: [
            { text: "1G", correct: false },
            { text: "2G", correct: true },
            { text: "AMPS", correct: false },
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "To uniquely identify a subscriber in a mobile network", correct: true },
            { text: "To increase signal strength", correct: false },
            { text: "To enable voice calls", correct: false }
        ]
    },
    {
        question: "Which technology is used for short-range communication between devices?",
        answers: [
...
const Satellite_Communication = [
    ...
    },
    {
        ...
        answers: [
            { text: "An orbit in which a satellite orbits the Earth in 90 minutes", correct: false },
            { text: "An orbit where the satellite appears stationary relative to the Earth's surface", correct: true },
            { text: "An orbit that passes over the poles", correct: false },
            { text: "An orbit that lies between Earth and the Moon", correct: false }
        ]
    },
    {
        question: "Which frequency band is primarily used for satellite communication?",
        answers: [
    ...
    {
        question: "What is the purpose of a transponder in a communication satellite?",
        answers: [
            { text: "To store energy", correct: false },
    ...
    {
        question: "What does the term 'footprint' refer to in satellite communication?",
        answers: [
            { text: "The weight of the satellite", correct: false },
            { text: "The coverage area of the satellite signal on Earth", correct: true },
            { text: "The size of the satellite", correct: false },
            { text: "The energy consumption of the satellite", correct: false }
        ]
    },
    {
        question: "Which component of a satellite communication system is located on Earth?",
        answers: [
    ...
    {
        question: "Which modulation technique is commonly used in satellite communication?",
        answers: [
            { text: "Amplitude Modulation (AM)", correct: false },
            { text: "Frequency Modulation (FM)", correct: false },
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "The ground equipment used for satellite communication", correct: false },
            { text: "A type of satellite orbit", correct: false }
        ]
    },
    {
        question: "What is the purpose of a beacon signal in satellite communication?",
        answers: [
            { text: "To locate the position of the satellite", correct: false },
            { text: "To measure signal strength", correct: false },
            { text: "To provide a reference for signal tracking and alignment", correct: true },
            { text: "To transmit data between satellites", correct: false }
        ]
    },
    {
        question: "What does the term 'uplink' refer to in satellite communication?",
        answers: [
    ...
    {
        question: "Which satellite system is used for global broadcasting services?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "An orbit that remains fixed above one point on Earth", correct: false },
            { text: "An orbit that is used by geostationary satellites", correct: false }
        ]
    },
    {
        question: "Which component of a satellite system amplifies the received signals?",
        answers: [
    ...
    {
        question: "What is the purpose of a parabolic dish in satellite communication?",
        answers: [
    ...
    {
        question: "Which type of orbit has the shortest orbital period around the Earth?",
        answers: [
            { text: "Geostationary Orbit (GEO)", correct: false },
    ...
    {
        question: "What is the primary advantage of using satellites for communication?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "A terrestrial terminal used to communicate with satellites", correct: true },
...
const Radar_and_Navigation = [
    ...
    {
        question: "Which system uses gyroscopes and accelerometers to determine position?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "Measuring the position relative to ground stations", correct: false },
            { text: "Using gyroscopes and accelerometers to track position changes", correct: true },
            { text: "Following a pre-determined route using maps", correct: false }
        ]
    },
    {
        question: "What type of radar is primarily used in automotive applications?",
        answers: [
            { text: "Surface radar", correct: false },
            { text: "Monopulse radar", correct: false },
    ...
    {
        question: "What is the main purpose of an Automatic Identification System (AIS) in maritime navigation?",
        answers: [
            { text: "To detect weather patterns", correct: false },
    ...
    {
        question: "Which component of a radar system determines the direction of the received signal?",
        answers: [
...
const Fluid_Mechanics = [
    {
        ...
        answers: [
            { text: "Solids have fixed shape and volume, while fluids have fixed volume.", correct: false },
            { text: "Solids have fixed volume, while fluids can change shape and volume.", correct: true },
            { text: "Solids have variable shape and volume, while fluids have fixed shape.", correct: false },
            { text: "Solids have variable shape and volume, while fluids can change volume.", correct: false }
        ]
    },
    {
    ...
    {
        question: "Which law of fluid mechanics states that the total energy of a fluid flowing along a streamline remains constant?",
        answers: [
    ...
    {
        question: "What phenomenon is responsible for the rise of liquids in capillary tubes?",
        answers: [
    ...
    {
        question: "What term describes the force per unit area exerted by a fluid at rest?",
        answers: [
    ...
    {
        question: "In fluid mechanics, which type of flow occurs when the Reynolds number is less than 2000?",
        answers: [
    ...
    {
        question: "What is the name of the equation that describes the flow of an incompressible fluid through a tube?",
        answers: [
    ...
    {
        question: "What is the term for the force that opposes the relative motion of two adjacent layers of fluid?",
        answers: [
            { text: "Surface tension", correct: false },
    ...
    {
        question: "Which law states that the buoyant force exerted by a fluid on a submerged object is equal to the weight of the fluid displaced?",
        answers: [
            { text: "Pascal's law", correct: false },
    ...
    {
        question: "What is the measure of the difficulty of initiating motion in a fluid?",
        answers: [
    ...
    {
        question: "In fluid mechanics, what is the term for the tendency of fluid particles to move from higher pressure to lower pressure?",
        answers: [
    ...
    {
        question: "Which term describes the property of a fluid that allows it to resist tensile stress and form droplets?",
        answers: [
            { text: "Surface tension", correct: true },
            { text: "Viscosity", correct: false },
    ...
    {
        question: "Which law states that the total pressure in a fluid remains constant along a streamline?",
        answers: [
            { text: "Pascal's law", correct: false },
            { text: "Archimedes' principle", correct: false },
            { text: "Bernoulli's equation", correct: true },
    ...
    {
        question: "What is the name of the force exerted by a fluid perpendicular to a surface?",
        answers: [
            { text: "Pressure", correct: true },
            { text: "Shear stress", correct: false },
    ...
    {
        question: "Which parameter is not considered in the Hagen-Poiseuille equation for laminar flow through a pipe?",
        answers: [
            { text: "Viscosity", correct: false },
    ...
    {
        question: "What is the term for the force that opposes the motion of an object through a fluid?",
        answers: [
    ...
    {
        question: "Which property of a fluid is defined as its mass per unit volume?",
        answers: [
            { text: "Pressure", correct: false },
            { text: "Viscosity", correct: false },
    ...
    {
        question: "What phenomenon allows fluids to rise in narrow tubes against gravity?",
        answers: [
            { text: "Viscosity", correct: false },
            { text: "Buoyancy", correct: false },
            { text: "Surface tension", correct: true },
...
const Surveying = [
    ...
    {
        question: "Which surveying technique uses satellite signals to determine positions on the Earth's surface?",
        answers: [
    ...
    {
        question: "What is the term for the process of marking points and angles on the ground before measurement in surveying?",
        answers: [
    ...
    {
        question: "Which type of surveying is used to create contour maps and determine elevations?",
        answers: [
            { text: "Aerial surveying", correct: false },
            { text: "Engineering surveying", correct: false },
    ...
    {
        question: "What is the term for the process of determining the boundaries of land ownership?",
        answers: [
            { text: "Topographic surveying", correct: false },
            { text: "Hydrographic surveying", correct: false },
    ...
    {
        question: "Which instrument is used to measure the vertical angles in surveying?",
        answers: [
    ...
    {
        question: "Which surveying technique uses cameras mounted on aircraft or drones to capture images of the Earth's surface?",
        answers: [
    ...
    {
        question: "Which type of surveying is used to measure and map large areas of land?",
        answers: [
            { text: "GPS surveying", correct: false },
            { text: "Aerial surveying", correct: true },
            { text: "Hydrographic surveying", correct: false },
    ...
    {
        question: "Which surveying method is used to measure distances using signals reflected from a prism?",
        answers: [
            { text: "Topographic surveying", correct: false },
            { text: "Aerial surveying", correct: false },
    ...
    {
        question: "What is the term for the error caused by the Earth's curvature in surveying?",
        answers: [
    ...
    {
        question: "Which surveying technique is used to measure and map underwater features?",
        answers: [
            { text: "Aerial surveying", correct: false },
            { text: "Hydrographic surveying", correct: true },
            { text: "GPS surveying", correct: false },
...
const Building_Materials = [
    ...
    {
        question: "What type of material is commonly used for roofing due to its durability and weather resistance?",
        answers: [
            { text: "Plastic", correct: false },
            { text: "Aluminum", correct: false },
    ...
    {
        question: "Which material is known for its high strength-to-weight ratio, making it suitable for structural applications?",
        answers: [
    ...
    {
        question: "Which material is used for its thermal insulation properties in buildings?",
        answers: [
    ...
    {
        question: "What type of material is commonly used for load-bearing walls in residential construction?",
        answers: [
            { text: "Concrete", correct: false },
            { text: "Wood", correct: false },
    ...
    {
        question: "Which material is known for its fire-resistant properties and is often used in fireproofing applications?",
        answers: [
    ...
    {
        question: "What type of material is used for plumbing pipes due to its corrosion resistance?",
        answers: [
    ...
    {
        question: "Which material is used for its acoustic insulation properties in buildings?",
        answers: [
            { text: "Concrete", correct: false },
            { text: "Asphalt", correct: false },
    ...
    {
        question: "Which material is commonly used for decorative finishes in interior construction?",
        answers: [
    ...
    {
        question: "What type of material is used for its flexibility and waterproofing properties in roofing?",
        answers: [
            { text: "Wood", correct: false },
            { text: "Asphalt", correct: true },
            { text: "Steel", correct: false },
    ...
    {
        question: "Which material is commonly used for flooring due to its durability and ease of maintenance?",
        answers: [
            { text: "Wood", correct: false },
    ...
    {
        question: "What type of material is used for its thermal insulation properties in roofs and walls?",
        answers: [
            { text: "Brick", correct: false },
            { text: "Fiberglass", correct: true },
            { text: "Concrete", correct: false },
    ...
    {
        question: "Which material is used for its strength and durability in foundation construction?",
        answers: [
            { text: "Plastic", correct: false },
    ...
    {
        question: "What type of material is used for its reflective properties in roofing?",
        answers: [
            { text: "Asphalt", correct: false },
    ...
    {
        question: "Which material is commonly used for external cladding due to its weather resistance?",
        answers: [
            { text: "Plastic", correct: false },
            { text: "Wood", correct: false },
            { text: "Steel", correct: false },
    ...
    {
        question: "Which material is commonly used for window frames due to its thermal insulation properties?",
        answers: [
            { text: "Steel", correct: false },
            { text: "Aluminum", correct: true },
            { text: "Wood", correct: false },
    ...
    {
        question: "What type of material is used for its durability and aesthetic appeal in exterior finishes?",
        answers: [
            { text: "Plastic", correct: false },
...
const Structural_Analysis = [
    {
        ...
        answers: [
            { text: "The study of structural components in architecture", correct: false },
            { text: "The examination of materials used in construction", correct: false },
            { text: "The prediction of the behavior of structures under loads", correct: true },
            { text: "The assessment of environmental impact on buildings", correct: false }
        ]
    },
    {
        question: "Which method is commonly used for analyzing statically determinate structures?",
        answers: [
    ...
    {
        question: "What is the purpose of a shear force diagram in structural analysis?",
        answers: [
    ...
    {
        question: "Which type of load is used to analyze the stability of structures?",
        answers: [
    ...
    {
        question: "What does the term 'moment distribution' refer to in structural analysis?",
        answers: [
    ...
    {
        question: "Which method is used to analyze indeterminate structures with fixed supports?",
        answers: [
    ...
    {
        question: "Which theorem is fundamental in the analysis of statically indeterminate structures?",
        answers: [
    ...
    {
        question: "What does the term 'deflection' refer to in structural analysis?",
        answers: [
    ...
    {
        question: "Which software is commonly used for computer-aided structural analysis?",
        answers: [
    ...
    {
        question: "Which concept is fundamental in analyzing the stability of frames and trusses?",
        answers: [
    ...
    {
        question: "What is the primary challenge in analyzing dynamically loaded structures?",
        answers: [
    ...
    {
        question: "Which concept is critical in analyzing the stability of slender columns?",
        answers: [
    ...
    {
        question: "What is the primary advantage of using matrix methods in structural analysis?",
        answers: [
    ...
    {
        question: "Which type of analysis is used to predict the response of structures to temperature variations?",
        answers: [
    ...
    {
        question: "Which parameter is critical in assessing the stability of arch bridges?",
        answers: [
...
const Concrete_Technology = [
    ...
    {
        question: "What is the process of compacting concrete to remove air voids called?",
        answers: [
    ...
    {
        question: "What is the term for the ability of concrete to resist weathering action?",
        answers: [
    ...
    {
        question: "Which factor primarily influences the strength of hardened concrete?",
        answers: [
    ...
    {
        question: "Which type of admixture is used to reduce the heat of hydration in concrete?",
        answers: [
    ...
    {
        question: "Which test is used to evaluate the compressive strength of hardened concrete?",
        answers: [
    ...
    {
        question: "What is the typical ratio of water to cement in concrete mixtures?",
        answers: [
    ...
    {
        question: "What does the term 'blinding' refer to in concrete construction?",
        answers: [
            { text: "Applying a finishing coat to concrete surfaces", correct: false },
    ...
    {
        question: "Which material is commonly used as a fine aggregate in concrete?",
        answers: [
            { text: "Gravel", correct: false },
    ...
    {
        question: "What is the term for the process of hardening and setting of concrete?",
        answers: [
            { text: "Curing", correct: false },
    ...
    {
        question: "Which method is used to measure the workability of fresh concrete by its flow?",
        answers: [
...
const Soil_Mechanics = [
    ...
    {
        question: "What is the term for the ability of soil to deform without breaking?",
        answers: [
    ...
    {
        question: "Which test is used to determine the particle size distribution of soil?",
        answers: [
    ...
    {
        question: "What is the term for the ability of soil to bear loads without failing?",
        answers: [
    ...
    {
        question: "Which soil parameter is defined as the ratio of void volume to total volume?",
        answers: [
    ...
    {
        question: "Which type of soil is typically used as a landfill liner due to its low permeability?",
        answers: [
            { text: "Gravel", correct: false },
            { text: "Sand", correct: false },
            { text: "Clay", correct: true },
    ...
    {
        question: "What is the term for the resistance of soil to deformation or rupture?",
        answers: [
            { text: "Plasticity", correct: false },
            { text: "Compressibility", correct: false },
            { text: "Strength", correct: true },
    ...
    {
        question: "Which soil type is known for its high shear strength and low compressibility?",
        answers: [
            { text: "Clay", correct: true },
            { text: "Silt", correct: false },
            { text: "Sand", correct: false },
    ...
    {
        question: "Which soil property determines the ease with which water can pass through it?",
        answers: [
            { text: "Strength", correct: false },
            { text: "Plasticity", correct: false },
    ...
    {
        question: "What is the term for the maximum water content at which a soil remains in a plastic state?",
        answers: [
    ...
    {
        question: "Which soil type is most susceptible to volume changes due to water content variations?",
        answers: [
            { text: "Gravel", correct: false },
            { text: "Silt", correct: false },
            { text: "Clay", correct: true },
    ...
    {
        question: "What is the term for the ratio of the weight of water to the weight of solids in a soil sample?",
        answers: [
    ...
    {
        question: "Which soil property indicates its ability to undergo deformation without rupture?",
        answers: [
            { text: "Strength", correct: false },
            { text: "Plasticity", correct: true },
            { text: "Compressibility", correct: false },
    ...
    {
        question: "What is the term for the reduction in volume of soil due to squeezing out of water under pressure?",
        answers: [
            { text: "Expansion", correct: false },
...
const Structural_Analysis1 = [
    {
        question: "What is Structural Analysis?",
        answers: [
            { text: "The study of internal forces and deformations in structures under loading", correct: true },
            { text: "The design of architectural layouts for buildings", correct: false },
            { text: "The analysis of structural damages in buildings", correct: false },
            { text: "The process of evaluating material strengths for construction", correct: false }
        ]
    },
    {
        question: "Which method is commonly used to analyze statically determinate structures?",
        answers: [
    ...
    {
        question: "What does the superposition principle state in structural analysis?",
        answers: [
            { text: "That structures with similar designs will have similar outcomes", correct: false },
            { text: "That the total response of a structure is the sum of responses due to each load separately", correct: true },
            { text: "That structural analysis should focus on the outermost elements of a building", correct: false },
            { text: "That structural defects can accumulate over time and weaken a building", correct: false }
        ]
    },
    {
        question: "Which type of structure is characterized by having only two supports?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "To determine the aesthetics of a building's design", correct: false },
            { text: "To assess the structural integrity and strength of a building", correct: true },
            { text: "To analyze the environmental impact of a building", correct: false },
            { text: "To measure the acoustic properties of a building", correct: false }
        ]
    },
    {
        question: "In structural dynamics, what does 'natural frequency' refer to?",
        answers: [
            { text: "The frequency of vibrations caused by external forces", correct: false },
            { text: "The frequency at which a structure tends to vibrate in the absence of external forces", correct: true },
            { text: "The frequency of resonance in structural components", correct: false },
            { text: "The frequency at which a structure undergoes material fatigue", correct: false }
        ]
    },
    {
        question: "Which structural analysis method is based on the concept of virtual work?",
        answers: [
    ...
    {
        question: "What is the primary role of a structural engineer in construction projects?",
        answers: [
            { text: "To design the interior layout of a building", correct: false },
            { text: "To supervise the installation of plumbing and electrical systems", correct: false },
            { text: "To ensure that a structure can withstand the loads and forces it will encounter", correct: true },
            { text: "To manage the financial aspects of a construction project", correct: false }
        ]
    },
    {
        question: "What is the significance of the 'moment of inertia' in structural analysis?",
        answers: [
            { text: "It determines the bending stress in a structural member", correct: true },
            { text: "It measures the overall weight distribution of a structure", correct: false },
            { text: "It represents the rotational stability of a building", correct: false },
            { text: "It quantifies the internal force interactions in a structure", correct: false }
        ]
    },
    {
        question: "What is the purpose of a structural shear test?",
        answers: [
            { text: "To analyze the compression strength of a building material", correct: false },
            { text: "To measure the deformation caused by lateral forces in a structure", correct: true },
            { text: "To assess the acoustic insulation of a building component", correct: false },
            { text: "To determine the thermal conductivity of structural elements", correct: false }
        ]
    },
    {
        question: "Which type of structural load primarily acts downward due to gravity?",
        answers: [
            { text: "Live load", correct: false },
    ...
    },
    {
        ...
        answers: [
            { text: "To calculate the structural weight distribution", correct: false },
            { text: "To determine the resistance of a structure to collapse or failure", correct: true },
            { text: "To assess the environmental impact of structural materials", correct: false },
            { text: "To analyze the acoustic performance of a building", correct: false }
        ]
    },
    {
        question: "Which structural material is known for its high strength-to-weight ratio?",
        answers: [
            { text: "Concrete", correct: false },
            { text: "Steel", correct: true },
            { text: "Wood", correct: false },
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "To enhance the aesthetic appearance of a building", correct: false },
            { text: "To regulate the internal temperature of a building", correct: false }
        ]
    },
    {
        question: "Which structural analysis method involves dividing the structure into sections and solving for internal forces?",
        answers: [
            { text: "Moment distribution method", correct: false },
            { text: "Finite element method (FEM)", correct: false },
            { text: "Method of Joints", correct: false },
    ...
    {
        question: "What is the significance of the 'yield strength' in structural materials?",
        answers: [
            { text: "It measures the tensile strength of a material", correct: false },
            { text: "It represents the maximum stress a material can endure without permanent deformation", correct: true },
            { text: "It quantifies the compressive strength of a material", correct: false },
            { text: "It indicates the resistance of a material to fatigue", correct: false }
        ]
    },
    {
        question: "Which structural element is designed to carry loads primarily by axial compression?",
        answers: [
            { text: "Beam", correct: false },
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "The excessive deformation of a structural member", correct: false },
            { text: "The sudden failure of a building under seismic load", correct: false },
            { text: "The sudden sideways deflection of a slender structural element under compressive stress", correct: true }
        ]
    },
    {
        ...
        answers: [
            ...
            { text: "To simulate the behavior of structures under various loads and conditions", correct: true },
            { text: "To control the temperature and humidity inside buildings", correct: false },
            { text: "To evaluate the environmental impact of construction projects", correct: false }
        ]
    },
    {
        question: "Which factor is crucial in determining the stability of a cantilever beam?",
        answers: [
    ...
    {
        question: "What is the primary consideration in selecting structural materials for bridges?",
        answers: [
...
const Irrigation_Engineering = [
    ...
    {
        question: "Which irrigation method involves delivering water directly to the root zone of plants?",
        answers: [
    ...
    {
        question: "What is the purpose of soil moisture sensors in irrigation systems?",
        answers: [
            { text: "To measure the pH level of soil", correct: false },
            { text: "To determine the nutrient content of soil", correct: false },
            { text: "To monitor soil moisture levels for efficient water management", correct: true },
            { text: "To detect soil compaction", correct: false }
        ]
    },
    {
        question: "Which factor is crucial in determining the water requirement for irrigation?",
        answers: [
    ...
    {
        question: "Which irrigation system is known for its high application efficiency?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "It allows for uniform application of water and nutrients", correct: true },
    ...
    {
        question: "What is the primary advantage of center pivot irrigation systems?",
        answers: [
            { text: "They are suitable for small-scale farming", correct: false },
            { text: "They allow for precise control over water application", correct: false },
            { text: "They are cost-effective for large-scale farming", correct: true },
            { text: "They reduce soil erosion", correct: false }
        ]
    },
    {
        question: "Which irrigation system is commonly used in greenhouse agriculture?",
        answers: [
            { text: "Sprinkler irrigation", correct: false },
            { text: "Flood irrigation", correct: false },
            { text: "Drip irrigation", correct: true },
    ...
    {
        question: "What is the role of evapotranspiration in irrigation scheduling?",
        answers: [
            { text: "To measure soil moisture levels", correct: false },
            { text: "To estimate water losses due to wind", correct: false },
            { text: "To calculate the water demand of crops based on climatic conditions", correct: true },
            { text: "To monitor water distribution in irrigation canals", correct: false }
        ]
    },
    {
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "It reduces water consumption in irrigation systems", correct: false },
            { text: "It combines fertilizer application with irrigation water for improved nutrient uptake by crops", correct: true },
            { text: "It enhances soil aeration", correct: false }
        ]
    },
    {
        question: "Which irrigation method is known for its ability to improve soil structure?",
        answers: [
            { text: "Flood irrigation", correct: false },
            { text: "Drip irrigation", correct: false },
            { text: "Furrow irrigation", correct: false },
    ...
    {
        question: "What is the purpose of soil conservation techniques in irrigation?",
        answers: [
            { text: "To prevent soil compaction", correct: false },
            { text: "To promote water infiltration and reduce erosion", correct: true },
